...
void ScalerUnpack::Register() { LOG(DEBUG) << "ScalerUnpack : Registering..."; }
    ...
    for (auto i : ROOT::MakeSeq(16)) {
        switch (i) {
            ...
            case 12:
                ...
                break;
            default:
                tree->Branch(TString::Format("SC%.2d", i), &(df->scalars[i]));
        }
    }
...
// Reset: Public method
void ScalerUnpack::Reset() { LOG(DEBUG) << "ScalerUnpack : Clearing Data Structure"; }
