...
class FixedTargetGenerator : public FairGenerator
{
  public:
    ...
    };   // charm geometry uses a different target, default one is usual
    ...
    {
        withEvtGen = true;
    }   // use EvtGen as external decayer to Pythia, experimental phase, only works for one Pythia instance
