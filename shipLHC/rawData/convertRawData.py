...
parser.add_argument(
    "-t", "--nStart", dest="nStart", help="first event to process", type=int, default=0
)
...
parser.add_argument(
    "-b", "--heartBeat", dest="heartBeat", help="heart beat", type=int, default=100000
)
parser.add_argument(
    "-cpp",
    "--convRawCPP",
...
if options.geoFile:
    ...
    if (options.geoFile).find("../") < 0:
        ...
        snd_geo = SndlhcGeo.GeoInterface(options.geoFile[3:])
else:
