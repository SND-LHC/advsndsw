  ...
  DS system horizontal(3) planes, 60 bars, readout on both sides, single channel
   ...
   """
    ...
    def Init(self, options, monitor):
        ...
        self.mufi_vsignal = 15.0 * u.cm / u.ns
        ...
        for xi in self.xing:
            ut.bookHist(
                h,
                detector + "Noise" + xi,
                "events with hits in single plane; s*10+l;",
                40,
                0.5,
                39.5,
            )
            for s in monitor.systemAndPlanes:
                ...
                for l in range(monitor.systemAndPlanes[s]):
                    ut.bookHist(
                        h,
                        detector + "hitmult_" + str(s * 10 + l) + xi,
                        "hit mult / plane " + sdict[s] + str(l) + "; #hits",
                        61,
                        -0.5,
                        60.5,
                    )
                    ut.bookHist(
                        h,
                        detector + "hit_" + str(s * 10 + l) + xi,
                        "channel map / plane " + sdict[s] + str(l) + "; #channel",
                        160,
                        -0.5,
                        159.5,
                    )
                    ut.bookHist(
                        h,
                        detector + "Xhit_" + str(s * 10 + l) + xi,
                        "Xchannel map / plane " + sdict[s] + str(l) + "; #channel",
                        160,
                        -0.5,
                        159.5,
                    )
                    ...
                    if s == 3:
                        ut.bookHist(
                            h,
                            detector + "bar_" + str(s * 10 + l) + xi,
                            "bar map / plane " + sdict[s] + str(l) + "; #bar",
                            60,
                            -0.5,
                            59.5,
                        )
                        ut.bookHist(
                            h,
                            detector + "dT_" + str(s * 10 + l) + xi,
                            "dT with respect to first scifi "
                            + sdict[s]
                            + str(l)
                            + "; dt [ns] ;# bar + channel",
                            100,
                        ...
                        ut.bookHist(
                            h,
                            detector + "dTcor_" + str(s * 10 + l) + xi,
                            "dTcor with respect to first scifi "
                            + sdict[s]
                            + str(l)
                            + "; dt [ns] ;# bar + channel",
                            100,
                        ...
                        if l == 4:
                            for ss in range(1, 6):
                                ut.bookHist(
                                    ...
                                    "deltaT scifi earliest hit versus DS hit 2H",
                                    200,
                                    -25.0,
                                    25.0,
                                )
                    ...
                    ut.bookHist(
                        h,
                        detector + "sig_" + str(s * 10 + l) + xi,
                        "signal / plane " + sdict[s] + str(l) + "; QDC [a.u.]",
                        200,
                        0.0,
                        200.0,
                    )
                    ...
                    ut.bookHist(
                        h,
                        detector + "occ_" + str(s * 10 + l) + xi,
                        "channel occupancy " + sdict[s] + str(l),
                        100,
                        0.0,
                        200.0,
                    )
                    ut.bookHist(
                        h,
                        detector + "occTag_" + str(s * 10 + l) + xi,
                        "channel occupancy " + sdict[s] + str(l),
                        100,
                        0.0,
                        200.0,
                    ...
                    ut.bookHist(
                        h,
                        detector + "leftvsright_1" + xi,
                        "Veto hits in left / right; Left: # hits; Right: # hits",
                        10,
                        -0.5,
                        9.5,
                        10,
                    ...
                    ut.bookHist(
                        h,
                        detector + "leftvsright_2" + xi,
                        "US hits in left / right; L: # hits; R: # hits",
                        10,
                        -0.5,
                        9.5,
                        10,
                    ...
                    ut.bookHist(
                        h,
                        detector + "leftvsright_3" + xi,
                        "DS hits in left / right; L: # hits; R: # hits",
                        2,
                        -0.5,
                        1.5,
                        2,
                    ...
                    ut.bookHist(
                        h,
                        detector + "leftvsright_signal_1" + xi,
                        "Veto signal in left / right; Left: QDC [a.u.]; Right: QDC [a.u.]",
                        100,
                        -0.5,
                        200.0,
                        100,
                    ...
                    ut.bookHist(
                        h,
                        detector + "leftvsright_signal_2" + xi,
                        "US signal in left / right; L: QDC [a.u.]; R: QDC [a.u.]",
                        100,
                        -0.5,
                        200.0,
                        100,
                    ...
                    ut.bookHist(
                        h,
                        detector + "leftvsright_signal_3" + xi,
                        "DS signal in left / right; L: QDC [a.u.]; R: QDC [a.u.]",
                        100,
                        -0.5,
                        200.0,
                        100,
                    ...
                    ut.bookHist(
                        h,
                        detector + "slopes" + xi,
                        "muon DS track slopes; slope X [rad]; slope Y [rad]",
                        150,
                        -1.5,
                        1.5,
                        150,
                    ...
                    for bar in range(monitor.systemAndBars[s]):
                        ut.bookHist(
                            h,
                            detector + "chanmult_" + str(s * 1000 + 100 * l + bar) + xi,
                            "channel mult / bar "
                            + sdict[s]
                            + str(l)
                            + "-"
                    ...
                    ut.bookHist(
                        h,
                        detector + "resX_" + sdict[s] + str(s * 10 + l) + xi,
                        "residual X" + str(s * 10 + l) + "; [#cm]",
                        100,
                        xmin,
                        xmax,
                        60,
                    ...
                    ut.bookHist(
                        h,
                        detector + "resY_" + sdict[s] + str(s * 10 + l) + xi,
                        "residual  Y" + str(s * 10 + l) + "; [#cm]",
                        100,
                        xmin,
                        xmax,
                        70,
    ...
    def ExecuteEvent(self, event):
        ...
        mult = {}
        planes = {}
        for i in self.listOfHits:
            self.listOfHits[i].clear()
        ...
        for aHit in event.Digi_MuFilterHits:
            ...
            self.M.fillHist1(
                detector + "chanmult_" + str(s * 1000 + 100 * l + bar), Nleft
            )
            self.M.fillHist1(
                detector + "chanmult_" + str(s * 1000 + 100 * l + bar), 10 + Nright
            )
            if not aHit.isVertical():  # vertical DS plane is read out only on one side
                ...
                self.M.fillHist2(
                    detector + "leftvsright_signal_" + str(s), Sleft, Sright
                )
            #
            for c in allChannels:
                ...
                if s == 2 and self.M.smallSiPMchannel(c):
                    self.M.fillHist1(
                        detector + "sigS_" + str(s) + str(l), allChannels[c]
                    )
                    if withDSTrack:
                        self.M.fillHist1(
                            detector + "TsigS_" + str(s) + str(l), allChannels[c]
                        )
                elif c < nSiPMs:
                    self.M.fillHist1(
                        detector + "sigL_" + str(s) + str(l), allChannels[c]
                    )
                    if withDSTrack:
                        self.M.fillHist1(
                            detector + "TsigL_" + str(s) + str(l), allChannels[c]
                        )
                else:
                    self.M.fillHist1(
                        detector + "sigR_" + str(s) + str(l), allChannels[c]
                    )
                    if withDSTrack:
                        self.M.fillHist1(
                            detector + "sigR_" + str(s) + str(l), allChannels[c]
                ...
                if withDSTrack:
                    self.M.fillHist1(
                        detector + "sig_" + str(s) + str(l), allChannels[c]
                    )
            allChannels.clear()
        #
        ...
        for s in systemAndPlanes:
            for l in range(systemAndPlanes[s]):
                self.M.fillHist1(
                    detector + "hitmult_" + str(s * 10 + l), mult[s * 10 + l]
                )
        ...
        for aTrack in self.M.Reco_MuonTracks:
            ...
            for aHit in event.Digi_MuFilterHits:
                ...
                self.M.fillHist2(
                    detector + "resX_" + sdict[s] + str(s * 10 + l), doca / u.cm, xEx
                )
                self.M.fillHist2(
                    detector + "resY_" + sdict[s] + str(s * 10 + l), doca / u.cm, yEx
                )
                # calculate time difference for DS
                if (s == 3 and abs(doca) < 2.5 * u.cm) or (
                    s == 1 and abs(doca) < 6 * u.cm
                ):
                    ...
                    for i in range(nmax):
                        ...
                        if s == 3:
                            if i == 1:
                                X = (
                                    B - posM
                                )  # B is right  only horizontal planes have a second readout
                            else:
                                X = (
                                    A - posM
                                )  # A is on the left, or top for vertical planes
                        if s == 1:
                            if i < 8:
                                X = A - posM
                            else:
                        ...
                        tM = (
                            aHit.GetTime(i) * self.M.TDC2ns
                            - L
                            - trajLength / u.speedOfLight
                        )
                        self.M.fillHist2(
                            detector + "dT_" + str(s * 10 + l),
                            tM - scifi_time0,
                            bar * barMult + i,
                        )
                        # use corrected time
                        if s == 3:
                            corTime = self.M.MuFilter.GetCorrectedTime(
                                detID, i, aHit.GetTime(i) * self.M.TDC2ns, X.Mag()
                            )
                            tM = corTime - trajLength / u.speedOfLight
                            self.M.fillHist2(
                                detector + "dTcor_" + str(s * 10 + l),
                                tM - scifi_time0,
                                bar * barMult + i,
                            )
                    if s == 3 and l == 2:
                        ...
                        if timeLeft > 0 and timeRight > 0:
                            dL = abs(A[0] - B[0])
                            avTime = self.M.MuFilter.GetCorrectedTime(
                                detID, 0, timeLeft * self.M.TDC2ns, 0
                            ) + self.M.MuFilter.GetCorrectedTime(
                                detID, 1, timeRight * self.M.TDC2ns, 0
                            )
                            dsHitTimes.append(
                                (avTime - abs(A[0] - B[0]) / 15) / 2
                            )  # L/2 / 15cm/ns
            ...
            if len(dsHitTimes) > 0:
                ...
                for scifiHit in event.Digi_ScifiHits:
                    ...
                    scifiHitTimes[s].append(
                        self.M.Scifi.GetCorrectedTime(
                            detID, scifiHit.GetTime() * self.M.TDC2ns, 0
                        )
                    )
                for s in scifiHitTimes:
                    if len(scifiHitTimes[s]) < 1:
                        continue
                    scifiHitTimes[s].sort()
                    deltaT = (
                        dsHitTimes[0]
                        - scifiHitTimes[s][0]
                        - (self.M.zPos["MuFilter"][34] - self.M.zPos["Scifi"][s * 10])
                        / u.speedOfLight
                    )
    ...
    def beamSpot(self, event):
        ...
        for aTrack in self.M.Reco_MuonTracks:
            ...
            if not Ybar < 0 and not Xbar < 0 and abs(slopeY) < 0.01:
                self.M.fillHist2(detector + "bsDS", Xbar, Ybar)
        ...
        for xi in self.xing:
            ...
            for s in S:
                ...
                if s == 3 or s == 1:
                    ut.bookCanvas(
                        h,
                        detector + "dTScifi" + sdict[s] + xi,
                        "dt rel to scifi" + sdict[s],
                        S[s][0],
                        S[s][1],
                        S[s][2],
                        S[s][3],
                    ...
                    ut.bookCanvas(
                        h,
                        detector + "dTcorScifi" + sdict[s] + xi,
                        "dtcor rel to scifi" + sdict[s],
                        S[s][0],
                        S[s][1],
                        S[s][2],
                        S[s][3],
            ...
            for i in range(5):
                h[detector + "lbar2" + xi].AddEntry(
                    h[detector + "bar_2" + str(i) + xi], "plane " + str(i + 1), "f"
                )
            ...
            for i in range(7):
                h[detector + "lbar3" + xi].AddEntry(
                    h[detector + "hit_3" + str(i) + xi], "plane " + str(i + 1), "f"
                )
            ...
            for i in range(1, 4):
                ...
                h[detector + "leftvsright_signal_" + str(i) + xi].SetMaximum(
                    h[detector + "leftvsright_signal_" + str(i) + xi].GetBinContent(
                        10, 10
                    )
                )
            ...
            for s in range(1, 4):
                h[detector + "lLRinEff" + str(s) + xi] = ROOT.TLegend(
                    0.6, 0.54, 0.99, 0.93
                )
                ...
                h[name + "1Y"].Draw("same")
                # Fill(Sleft,Sright)
                h[detector + "lLRinEff" + str(s) + xi].AddEntry(
                ...
                h[detector + "lLRinEff" + str(s) + xi].AddEntry(
                    h[name + "1X"], "left all", "f"
                )
                h[detector + "lLRinEff" + str(s) + xi].AddEntry(
                    h[name + "1Y"], "right all", "f"
                )
                ...
                for l in range(self.M.systemAndPlanes[s]):
                    ...
                    for bar in range(self.M.systemAndBars[s]):
                        ...
                        i = (
                            l
                            + 1
                            + (self.M.systemAndBars[s] - bar - 1)
                            * self.M.systemAndPlanes[s]
                        )
                        if s == 3:
                            ix = bar // 15 + 1 + (l // 2) * 4
                            iy = 15 - bar % 15
                        ...
                        h[hname].SetMaximum(
                            h[hname].GetBinContent(h[hname].GetMaximumBin()) * 1.2
                        )
                        h[hname].Draw()
            ...
            for canvas in [
                ...
                h[canvas].Update()
                if x != "":
                    self.M.myPrint(h[canvas], canvas, subdir="mufilter/" + xi)
                else:
            ...
            ut.bookCanvas(
                h,
                detector + "TtrackPos" + xi,
                "track position first state",
                1200,
                800,
                1,
                2,
            ...
            if x != "":
                self.M.myPrint(
                    h["muonDSTracks" + xi],
                    "muonDSTrackdirection" + xi,
                    subdir="mufilter/" + xi,
                )
                self.M.myPrint(
                    self.M.h[detector + "TtrackPos" + xi],
                    detector + "trackPos" + xi,
                    subdir="mufilter/" + xi,
                )
            else:
            ...
            # residuals
            ut.bookCanvas(
                h, detector + "residualsVsX" + xi, "residualsVsX ", 1200, 1200, 2, 7
            )
            ut.bookCanvas(
                h, detector + "residualsVsY" + xi, "residualsVsY ", 1200, 1200, 2, 7
            )
            ...
            if x != "":
                self.M.myPrint(
                    self.M.h[detector + "residualsVsX" + xi],
                    detector + "residualsVsX",
                    subdir="mufilter/" + xi,
                )
                self.M.myPrint(
                    self.M.h[detector + "residualsVsY" + xi],
                    detector + "residualsVsY",
                    subdir="mufilter/" + xi,
                )
                self.M.myPrint(
                    self.M.h[detector + "residuals" + xi],
                    detector + "residuals",
                    subdir="mufilter/" + xi,
                )
            else:
            ...
            if "B2noB1" in self.xing:
                ...
                for s in range(1, 6):
                    ...
                    self.M.h["deltaTScifiMufiHit_" + str(s) + "B2noB1"].SetLineColor(
                        s + 1
                    )
                    self.M.h["deltaTScifiMufiHit_" + str(s) + "B2noB1"].Draw("samehist")
            self.M.myPrint(
                self.M.h["dt" + xi], "scifi DS hit difference", subdir="mufilter"
            )
...
class Mufi_largeVSsmall(ROOT.FairTask):
                ...
                for side in ["L", "R"]:
                    for i1 in range(7):
                        for i2 in range(i1 + 1, 8):
                            tag = ""
                            if S == 2 and monitor.smallSiPMchannel(i1):
                                tag = "s" + str(i1)
                            else:
                                tag = "l" + str(i1)
                            if S == 2 and monitor.smallSiPMchannel(i2):
                                tag += "s" + str(i2)
                            else:
                                tag += "l" + str(i2)
                            ut.bookHist(
                                h,
                                sdict[S] + "cor" + tag + "_" + side + str(l),
    ...
    def ExecuteEvent(self, event):
        ...
        for aHit in event.Digi_MuFilterHits:
            ...
            rc = h["SVSl_" + str(l)].Fill(sumS / 4.0, sumL / 12.0, W)
            #
            for side in ["L", "R"]:
                offset = 0
                if side == "R":
                ...
                for i1 in range(offset, offset + 7):
                    ...
                    for i2 in range(i1 + 1, offset + 8):
                        if not (i2) in allChannels:
                            continue
                        if s == 2 and self.M.smallSiPMchannel(i1):
                            tag = "s" + str(i1 - offset)
                        else:
                            tag = "l" + str(i1 - offset)
                        if s == 2 and self.M.smallSiPMchannel(i2):
                            tag += "s" + str(i2 - offset)
                        else:
                            tag += "l" + str(i2 - offset)
                        qdc2 = allChannels[i2]
                        rc = h[sdict[s] + "cor" + tag + "_" + side + str(l)].Fill(
                            qdc1, qdc2, W
                        )
                        rc = h[
                            sdict[s] + "cor" + tag + "_" + side + str(l) + str(bar)
                        ].Fill(qdc1, qdc2, W)
            allChannels.clear()
    ...
    def Plot(self):
        ...
        for S in [1, 2]:
            for l in range(systemAndPlanes[S]):
                for side in ["L", "R"]:
                    ut.bookCanvas(
                        h, sdict[S] + "cor" + side + str(l), "", 1800, 1400, 7, 4
                    )
                    k = 1
                    for i1 in range(7):
                        for i2 in range(i1 + 1, 8):
...
class Veto_Efficiency(ROOT.FairTask):
    ...
    def Init(self, options, monitor):
        ...
        for noiseCut in self.noiseCuts:
            ut.bookHist(
                h,
                "timeDiffPrev_" + str(noiseCut),
                "time diff; [clock cycles] ",
                100,
                -0.5,
                999.5,
            )
            ut.bookHist(
                h,
                "XtimeDiffPrev_" + str(noiseCut),
                "time diff no hits; [clock cycles] ",
                100,
                -0.5,
                999.5,
            )
            ut.bookHist(
                h,
                "timeDiffNext_" + str(noiseCut),
                "time diff next; [clock cycles] ",
                100,
                -0.5,
                999.5,
            )
            ut.bookHist(
                h,
                "XtimeDiffNext_" + str(noiseCut),
                "time diff next no hits; [clock cycles] ",
                100,
                -0.5,
                999.5,
            )
            for c in ["", "NoPrev", "TiNoFi"]:
                for b in ["", "beam"]:
                    ...
                    ut.bookHist(
                        h,
                        nc + "PosVeto_11",
                        "track pos at veto AND hit" + ";X [cm]; Y [cm]",
                        110,
                        -55.0,
                        0.0,
                        110,
                    ...
                    ut.bookHist(
                        h,
                        nc + "PosVeto_00",
                        "track pos at veto OR hit" + ";X [cm]; Y [cm]",
                        110,
                        -55.0,
                        0.0,
                        110,
                    ...
                    ut.bookHist(
                        h,
                        nc + "XPosVeto_11",
                        "track pos at veto no hit" + ";X [cm]; Y [cm]",
                        110,
                        -55.0,
                        0.0,
                        110,
        ...
        ut.bookHist(h, "deltaT", "delta T DS 2 and Scifi 1", 100, -20.0, 20.0)
        ut.bookHist(
            h, "X/Y", "xy matching of scifi DS", 100, -20.0, 20.0, 100, -20.0, 20.0
        )
    ...
    def ExecuteEvent(self, event):
        ...
        if dT < self.deadTime and dT > vetoHitsFromPrev:
            ...
            if event.EventHeader.GetRunId() > 6567 and N1 > 0:
                tightNoiseFilter, otherFastTrigger, otherAdvTrigger, Nprev, dt = (
                    self.checkOtherTriggers(event)
                )
        ...
        if (
            self.M.EventNumber - self.eventBefore["N"] > 1
        ) and self.M.options.postScale < 2:
            print("what is going on?", self.M.EventNumber, self.eventBefore["N"])
        self.eventBefore["N"] = self.M.EventNumber

        rc = h["scaler"].Fill(11)
        if self.M.Reco_MuonTracks.GetEntries() < 2:
            return  # require Scifi and DS track
        ...
        for scifiTrack in self.M.Reco_MuonTracks:
            if not scifiTrack.GetUniqueID() == 1:
                continue
            fitStatus = scifiTrack.getFitStatus()
            if not fitStatus.isFitConverged():
                continue
            if fitStatus.getNdf() < 5 or fitStatus.getNdf() > 12:
                continue
            if fitStatus.getChi2() / fitStatus.getNdf() > 80:
                continue
        ...
        if not scifiOneEff and len(planes) < 8:
            return
        if scifiOneEff and len(planes) < 10:
            return
        rc = h["scaler"].Fill(0)
        if not prevEvent:
            rc = h["scaler"].Fill(1)
        ...
        for aTrack in self.M.Reco_MuonTracks:
            ...
            beam = False
            if abs(mom.x() / mom.z()) < 0.1 and abs(mom.y() / mom.z()) < 0.1:
                beam = True
                # extrapolate to veto
            ...
            if (T1 - T0) < 100 and self.M.options.postScale < 2:
                if not prevEvent:
                    print("what is going on?", N1, T1, T0, N1 - 1, tmpN, tmpT)
                prevEvent = True
            s = 1
            xEx = {}
            yEx = {}
                ...
                for noiseCut in self.noiseCuts:
                    ...
                    if l == 0:
                        ...
                        if hits[0] > noiseCut and hits[1] > noiseCut:
                            ...
                            if beam:
                                rc = h[nc + "beamPosVeto_11"].Fill(xEx[l], yEx[l])
                        if hits[0] > noiseCut or hits[1] > noiseCut:
                            rc = h[nc + "PosVeto_00"].Fill(xEx[l], yEx[l])
                            if tightNoiseFilter:
                                h[ncL + "PosVeto_00"].Fill(xEx[l], yEx[l])
                            if beam:
                                rc = h[nc + "beamPosVeto_00"].Fill(xEx[l], yEx[l])
                        else:
                            if (
                                -45 < xEx[l]
                                and xEx[l] < -10
                                ...
                                if not prevEvent or (
                                    prevEvent and not tightNoiseFilter
                                ):
                                    if self.debug:
                                        print(
                                            "no hits",
                            ...
                            if beam:
                                rc = h[nc + "beamXPosVeto_11"].Fill(xEx[l], yEx[l])
                            if tightNoiseFilter:
    ...
    def checkOtherTriggers(self, event, debug=False):
        ...
        Nprev = 1
        if N < Nprev:
            return otherFastTrigger, otherAdvTrigger, tightNoiseFilter, -1, 0
        ...
        while dt < self.deadTime and N > Nprev:
            ...
            for x in event.EventHeader.GetFastNoiseFilters():
                if debug:
                    print("fast:", x.first, x.second)
                if x.second and not x.first == "Veto_Total":
                    otherFastTrigger = True
            otherAdvTrigger = False
            for x in event.EventHeader.GetAdvNoiseFilters():
                if debug:
                    print("adv:", x.first, x.second)
                if x.second and not x.first == "VETO_Planes":
                    otherAdvTrigger = True
            if debug:
                print("pre event ", Nprev, dt, otherFastTrigger, otherAdvTrigger)
    ...
    def Plot(self, beamOnly=False):
        ...
        for c in ["", "NoPrev"]:
            ...
            for noiseCut in self.noiseCuts:
                ...
                for l in ["0", "1", "00", "11"]:
                    h[nc + "Veto_ineff" + l] = h[nc + "PosVeto_" + l].Clone(
                        nc + "Veto_ineff" + l
                    )
                    h[nc + "Veto_ineff" + l].SetTitle(
                        "Veto inefficiency " + l + " noise cut=" + str(noiseCut)
                    )
                    ...
                    for iy in range(allTracks.GetNbinsY()):
                        for l in ["0", "1", "00", "11"]:
                            ...
                            if bc < 100:
                                ...
                                h[nc + "Veto_ineff" + l].SetBinContent(
                                    ix,
                                    iy,
                                    max(
                                        h[nc + "XPosVeto_" + l].GetBinContent(
                                            ix + 1, iy + 1
                                        )
                                        / bc,
                                        2.7 / bc,
                                ...
                                h[nc + "Veto_ineff" + l].SetBinError(
                                    ix,
                                    iy,
                                    h[nc + "XPosVeto_" + l].GetBinError(ix + 1, iy + 1)
                                    / bc,
                                )
                ...
                ineffOR = h[nc + "XPosVeto_11"].GetEntries() / (
                    Ntot.GetEntries() + 1e-20
                )
                ineffAND = 1.0 - h[nc + "PosVeto_11"].GetEntries() / (
                    Ntot.GetEntries() + 1e-20
                )
                region = [21, 91, 34, 89]
                ...
                Ntot_r = (
                    Ntot.Integral(region[0], region[1], region[2], region[3]) + 1e-20
                )
                ineff0_r = (
                    h[nc + "XPosVeto_0"].Integral(
                        region[0], region[1], region[2], region[3]
                    )
                    / Ntot_r
                )
                ineff1_r = (
                    h[nc + "XPosVeto_1"].Integral(
                        region[0], region[1], region[2], region[3]
                    )
                    / Ntot_r
                )
                ineffOR_r = (
                    h[nc + "XPosVeto_11"].Integral(
                        region[0], region[1], region[2], region[3]
                    )
                    / Ntot_r
                )
                ...
                print(
                    "global inefficiency veto0: %5.2F%% veto1: %5.2F%% veto0AND1: %5.2F%% veto0OR1: %5.2F%%"
                    % (ineff0 * 100, ineff1 * 100, ineffAND * 100, ineffOR * 100)
                )
                print(
                    "region %5.2F < X < %5.2F and %5.2F < Y < %5.2F "
                    % (
                        xax.GetBinCenter(region[0]),
                        xax.GetBinCenter(region[1]),
                        yax.GetBinCenter(region[0]),
                        yax.GetBinCenter(region[1]),
                    )
                )
                print(
                    "veto0: %5.2F%% veto1: %5.2F%% veto0AND1: %5.2F%% veto0OR1: %5.2F%%"
                    % (
                        ineff0_r * 100,
                        ineff1_r * 100,
                        ineffAND_r * 100,
