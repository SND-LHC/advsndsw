...
group.add_argument(
    "--H6",
    dest="testbeam",
    help="use geometry of H8/H6 testbeam setup",
    action="store_true",
)
group.add_argument(
    "--AdvSND", help="Use AdvSND setup", required=False, action="store_true"
)
parser.add_argument(
    "--Genie",
    dest="genie",
    help="Genie for reading and processing neutrino interactions (1 standard, 2 FLUKA, 3 Pythia, 4 GENIE geometry driver)",
    required=False,
    default=0,
    type=int,
)
...
parser.add_argument(
    "--zMax",
    type=float,
    help="max distance to apply energy cut",
    dest="zmax",
    default=70000.0,
)
parser.add_argument(
...
parser.add_argument(
    "--enhancePiKaDecay",
    dest="enhancePiKaDecay",
    help="decrease charged pion and kaon lifetime",
    required=False,
    type=float,
    default=0.0,
)
parser.add_argument(
    "--debug",
    dest="debug",
    help="debugging mode, check for overlaps",
    required=False,
    action="store_true",
)
parser.add_argument(
...
parser.add_argument(
    "--EmuDet",
    "--nuTargetActive",
    dest="nuTargetPassive",
    help="activate emulsiondetector",
    required=False,
    action="store_false",
)
parser.add_argument(
    "--NagoyaEmu",
    "--useNagoyaEmulsions",
    dest="useNagoyaEmulsions",
    help="use bricks of 57 Nagoya emulsion films instead of 60 Slavich",
    required=False,
    action="store_true",
)
