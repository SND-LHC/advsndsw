...
//   to get the transformation
  ...
  // auto Detpos = new TGeoTranslation("Detpos", ShiftX-99.997800/2+22., ShiftY+113.988714/2.-10,
  // ShiftZ+2*279.160616-22.-250); // new 2024
  auto Detpos = new TGeoTranslation("Detpos",
                                    ShiftX - 99.997800 / 2 + 22.,
                                    ShiftY + 113.988714 / 2. - 10 - 9 - 4,
                                    ShiftZ + 2 * 279.160616 - 22. - 250);   // new 2024
...
*/
 ...
 // auto cutOut   = new TGeoCompositeShape("cutOut",
 // "BigBox:TR_1-Ftotal2-(TI18_1_Funion+TI18_2_Funion+TI18_3_Funion)-RockDetShape:RockDetpos");
