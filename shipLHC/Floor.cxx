...
void Floor::Initialize() { FairDetector::Initialize(); }
...
TVector3 Floor::crossing(TVector3 H1, TVector3 H2, TVector3 H3, TVector3 P1, TVector3 P2, TVector3 P3)
{
    ...
    TMatrixD P(3, 1);
    TMatrixD X(3, 1);
    std::map<int, TVector3> Row = {{0, H1}, {1, H2}, {2, H3}};
    std::map<int, TVector3> P123 = {{0, P1}, {1, P2}, {2, P3}};
    for (int j = 0; j < 3; j += 1) {
...
void Floor::ConstructGeometry()
{
    ...
    TGeoVolume *detector =
        new TGeoVolumeAssembly("Detector");   // assembly to place detetector elements in local coordinates
    ...
    **/
    ...
    Double_t M[9] = {
        0.999978, -0.006606, 0.0000821516, 0.00660651, 0.999901, -0.0124347, 4.69368E-15, 0.0124349, 0.999923};
    ...
    Double_t CurrentTargetY =
        9.564471
        + 5.368296;   // current y coordinate of the target low edge, hardcoded due to time constraints, find better way

    Double_t ShiftX = TargetX / 2. + 0.0033519999999995775 + 2.;
    Double_t ShiftY = -CurrentTargetY - 20.188581 + 4;
    Double_t ShiftZ = -400.;
    ////////////////////////////////////////////
    auto localSND_physCS_comb = new TGeoCombiTrans(
        "localSND_physCS",
        0. + ShiftX,
        0. + ShiftY,
        0. + ShiftZ,
        localSND_physCS_rot);   // origin is 480m downstream of IP1, shifting the apparatus 4m upstream
    ...
    std::vector<double> TI18_o1 = {-221.4191473578,
                                   76.66172460057,
                                   48820.152816717,
                                   131.72892289383,
                                   33.003800302801,
                                   -543.2846767937,
                                   200.28612174928};
    std::vector<double> TI18_i1 = {
        -221.4191473578, 76.66172460057, 48820.152816717, 131.72892289383, 33.003800302801, -543.2846767937, 175.0};
    std::vector<double> TI18_o2 = {
        -92.57914735775, 108.94172460057, 48288.782816717, 130.14367334394, 56.877589206698, -479.4033418058, 200.0};
    std::vector<double> TI18_i2 = {
        -92.57914735775, 108.94172460057, 48288.782816717, 130.14367334394, 56.877589206698, -479.4033418058, 175.0};
    std::vector<double> TI18_o3 = {
        14.66085264225, 155.81172460057, 47893.742816717, 1387.8506462618, 818.72395745673, -4733.240081082, 200.0};
    std::vector<double> TI18_i3 = {
        14.66085264225, 155.81172460057, 47893.742816717, 1387.8506462618, 818.72395745673, -4733.240081082, 175.0};
    ...
    std::vector<double> UJ18_x = {
        -92.57914735775, 108.94172460057, 48288.782816717, -141.138131672, -35.36121461014, 582.09072513608, 175.0};
    ...
    std::vector<double> tu011_o = {
        -522.09173359, 30., 4.6171636594E+04, -99.7891926, 0.0, 1954.9587043, 250.0, 360., 850.};
    std::vector<double> tu010_i = {-451.24339295, 30., 4.4607412772E+04, -89.817671994, 0.0, 1955.4422017, 220.0};
    std::vector<double> tu010_o = {
        -451.24339295, 30., 4.4607412772E+04, -89.817671994, 0.0, 1955.4422017, 250.0, 750., 1100.};
    // PLA   TI18_01 and TI18_02
    std::vector<double> TI18_1_bot = {0.67644808637366,
                                      -74.85571453913,
                                      -4.530940169849,
                                      -221.4171473578,
                                      -18.33127539943,
    ...
    std::vector<double> TI18_1_sid = {-95.08832719702,
                                      21.886725033285,
                                      -21.89021009926,
                                      -39.11837578468,
                                      3.7557255037298,
    ...
    std::vector<double> TI18_2_bot = {1.590393176461,
                                      -74.48871190132,
                                      -8.55964069504,
                                      -92.6293750264,
                                      13.94692460057,
    ...
    std::vector<double> TI18_2_sid = {9.5229226656561,
                                      -2.052234306283,
                                      2.2588218587662,
                                      119.6722824853,
                                      -43.26523379053,
    ...
    std::vector<double> TI18_3_bot = {2.6719179804842,
                                      -74.62099192635,
                                      -12.16834081665,
                                      237.27547988904,
                                      188.51303030346,
    ...
    std::vector<double> TI18_3_sid = {9.4281652604622,
                                      -2.374007701455,
                                      2.3396124281475,
                                      399.46744859669,
                                      116.81598987751,
    ...
    std::map<TString, std::vector<double>> geoParameters = {
        {"TI18_o1", TI18_o1},       {"TI18_i1", TI18_i1},       {"TI18_o2", TI18_o2},       {"TI18_i2", TI18_i2},
        {"TI18_o3", TI18_o3},       {"TI18_i3", TI18_i3},       {"UJ18_o", UJ18_o},         {"UJ18_i", UJ18_i},
        {"tu010_o", tu010_o},       {"tu010_i", tu010_i},       {"tu011_o", tu011_o},       {"tu011_i", tu011_i},
        {"tu012_o", tu012_o},       {"tu012_i", tu012_i},       {"UJ18_x", UJ18_x},         {"PM18_ci", PM18_ci},
        {"PM18_co", PM18_co},       {"TI18_1_bot", TI18_1_bot}, {"TI18_1_sid", TI18_1_sid}, {"TI18_2_bot", TI18_2_bot},
        {"TI18_2_sid", TI18_2_sid}, {"TI18_3_bot", TI18_3_bot}, {"TI18_3_sid", TI18_3_sid}};
    ...
    for (auto it = std::begin(loop1); it != std::end(loop1); ++it) {
        ...
        LOG(DEBUG) << "Floor: " << geoParameters[name_i.Data()][0] << " " << geoParameters[name_i.Data()][1] << " "
                   << geoParameters[name_i.Data()][2] << " " << name_i;
        TVector3 P = TVector3(
            geoParameters[name_i.Data()][0], geoParameters[name_i.Data()][1], geoParameters[name_i.Data()][2] - SND_Z);
        TVector3 H =
            TVector3(geoParameters[name_i.Data()][3], geoParameters[name_i.Data()][4], geoParameters[name_i.Data()][5]);
        auto T = P + 0.5 * H;
        ...
        std::map<TString, TVector3> face = {{"front", P}, {"back", P + H}};
...
#
        ...
        auto RF = new TGeoRotation("R_tube_" + name,
                                   rotAlpha * 180. / TMath::Pi(),
                                   rotBeta * 180. / TMath::Pi(),
                                   rotGamma * 180. / TMath::Pi());
        ...
        for (auto il = std::begin(loopF); il != std::end(loopF); ++il) {
            ...
            LOG(DEBUG) << "top left " << X0[0] << "," << X0[1] << "," << X0[2] << ";  " << P1[0] << "," << P1[1] << ","
                       << P1[2];
            ...
            LOG(DEBUG) << "top right " << X0[0] << "," << X0[1] << "," << X0[2] << ";  " << P2[0] << "," << P2[1] << ","
                       << P2[2];
            ...
            LOG(DEBUG) << "bottom right " << X0[0] << "," << X0[1] << "," << X0[2] << ";  " << P3[0] << "," << P3[1]
                       << "," << P3[2];
            ...
            LOG(DEBUG) << "bottom left " << X0[0] << "," << X0[1] << "," << X0[2] << ";  " << P4[0] << "," << P4[1]
                       << "," << P4[2];
        }
        ...
        auto tube = gGeoManager->MakeTube(
            name + "_tube", concrete, geoParameters[name_i.Data()][6], geoParameters[name_o.Data()][6], H.Mag() / 2.);
        auto Fulltube =
            gGeoManager->MakeTube(name + "_fulltube", concrete, 0., geoParameters[name_o.Data()][6], H.Mag() / 2.);
        ...
        auto sunion =
            new TGeoCompositeShape(name + "_union",
                                   "(" + name + "_tube:T_" + name + "+" + name + "_arb8:T_floor_" + name + "-" + name
                                       + "_arb8:T_floorS1_" + name + "-" + name + "_arb8:T_floorS2_" + name + ")");
        shapes.push_back(sunion);
        auto Fsunion = new TGeoCompositeShape(name + "_Funion",
                                              "(" + name + "_fulltube:T_" + name + "+" + name + "_arb8:T_floor_" + name
                                                  + "-" + name + "_arb8:T_floorS1_" + name + "-" + name
    ...
    auto Detpos = new TGeoTranslation("Detpos",
                                      ShiftX - 99.997800 / 2 + 22.,
                                      ShiftY + 113.988714 / 2. - 10,
                                      ShiftZ + 2 * 279.160616 - 22. - 30);   // new 2024
    ...
    for (auto it = std::begin(loop2); it != std::end(loop2); ++it) {
        ...
        TVector3 H =
            TVector3(geoParameters[name_i.Data()][3], geoParameters[name_i.Data()][4], geoParameters[name_i.Data()][5]);
        auto vol = gGeoManager->MakeTube(*it,
                                         concrete,
                                         geoParameters[name_i.Data()][6],
                                         geoParameters[name_o.Data()][6],
                                         H.Mag() / 2. - 5.);   // subtract 5cm to avoid overlap
        ...
        auto R = new TGeoRotation(
            name, rotAlpha * 180. / TMath::Pi(), rotBeta * 180. / TMath::Pi(), rotGamma * 180. / TMath::Pi());
    ...
    /*
      ...
      for(auto it = std::begin(loopr); it != std::end(loopr); ++it) {
        ...
        TVector3 H =
    TVector3(geoParameters[name_o.Data()][3],geoParameters[name_o.Data()][4],geoParameters[name_o.Data()][5]); auto tube
    = new TGeoTube(name_x,0., geoParameters[name_o.Data()][6]+10.,H.Mag()/2.+0.1); auto cone    =
    gGeoManager->MakeCone(name_b,rock,H.Mag()/2.,0.,geoParameters[name_o.Data()][8],0.,geoParameters[name_o.Data()][7]);
    ...
    // add rock up to Fluka scoring plane, 409 m from IP1.
      ...
      auto fluka = gGeoManager->MakeBox("FlukaScoringPlane",rock,
    geoParameters["tu010_o"][8],geoParameters["tu010_o"][8],dz); fluka->SetLineColor(kRed); tunnel->AddNode(fluka,1, new
    TGeoTranslation(-350.,0,dz+zs- SND_Z-50.));  // move 50cm upstream to avoid overlap
    */
    TGeoBBox *RockDetShape = new TGeoBBox("RockDetShape", detdim.X() + 30, detdim.Y() + 30, detdim.Z() + 180);
    auto RockDetpos = new TGeoTranslation("RockDetpos",
                                          ShiftX - 99.997800 / 2 + 22.,
                                          ShiftY + 113.988714 / 2. - 10,
                                          ShiftZ + 2 * 279.160616);   // new 2024
    ...
    auto TR_1 = new TGeoTranslation("TR_1",
                                    0.,
                                    0.,
                                    -dz + geoParameters["TI18_o1"][2] - SND_Z
                                        - 50.);   // move a bit more upstream to have free view from the back
    TR_1->RegisterYourself();
    auto cutOut = new TGeoCompositeShape(
        "cutOut", "BigBox:TR_1-Ftotal2-(TI18_1_Funion+TI18_2_Funion+TI18_3_Funion)-RockDetShape:RockDetpos");
    ...
    TGeoBBox *CBLateral_a = new TGeoBBox(
    ...
    TGeoBBox *CBExtraLat_a = new TGeoBBox(
        "CBExtraLat_a", fAcrylicWidth / 2., fCBFrontWallYDim / 2., (fCBExtraZDim - 2 * fAcrylicWidth) / 2.);
    TGeoBBox *CBTiny1_a = new TGeoBBox(
        "CBTiny1_a", fAcrylicWidth / 2., fCBFrontWallYDim / 2., (fCBTinyZDim - fAcrylicWidth - fBPolyWidth) / 2.);
    TGeoBBox *CBTiny2_a =
    ...
    TGeoTranslation *CBWallpos = new TGeoTranslation(
        "CBWallpos", (fCBRearWallXDim - fFeBlockX) / 2. - 28.5, (fCBFrontWallYDim - fFeBlockY) / 2. - 118., 0);
    ...
    TGeoTranslation *FrontWallpos =
        new TGeoTranslation("FrontWallpos",
                            -fCBRearWallXDim / 2. - fCBExtraXDim + fAcrylicWidth + fCBFrontWallXDim / 2.,
                            0,
                            -(fSlopedWallZProj + 2 * (fCBTinyZDim - fAcrylicWidth) + fAcrylicWidth) + fBPolyWidth);
    FrontWallpos->RegisterYourself();
    TGeoTranslation *Tiny1pos = new TGeoTranslation(
    ...
    TGeoTranslation *SlopeWallpos =
        new TGeoTranslation("SlopeWallpos",
                            ...
                            0,
                            -fCBTinyZDim - fSlopedWallZProj / 2. + fAcrylicWidth / 2. + fBPolyWidth);
    ...
    TGeoTranslation *CBExtraLatpos = new TGeoTranslation("CBExtraLatpos",
                                                         -fCBRearWallXDim / 2. + fAcrylicWidth / 2.,
                                                         0,
    ...
    TGeoTranslation *CBLateralpos =
        new TGeoTranslation("CBLateralpos",
                            -fCBRearWallXDim / 2. - fCBExtraXDim + fAcrylicWidth + fAcrylicWidth / 2.,
                            0,
                            fCBExtraZDim - fCBLatWallZDim / 2. - fAcrylicWidth / 2.);
    CBLateralpos->RegisterYourself();
    TGeoTranslation *CBLatCov1pos = new TGeoTranslation("CBLatCov1pos",
                                                        -fCBRearWallXDim / 2. - fCBExtraXDim + fAcrylicWidth,
                                                        -fCBFrontWallYDim / 2.,
                                                        fCBExtraZDim - fCBLatWallZDim / 2. - fAcrylicWidth / 2.);
    ...
    TGeoTranslation *CBLatCov23pos = new TGeoTranslation("CBLatCov23pos",
                                                         (fCBRearWallXDim - fAcrylicWidth) / 2. - fAcrylicWidth / 2.,
                                                         -fCBFrontWallYDim / 2.,
                                                         -fCBTinyZDim / 2. + fBPolyWidth + 0.5);
    CBLatCov23pos->RegisterYourself();
    TGeoTranslation *CBFrontCov1pos =
        new TGeoTranslation("CBFrontCov1pos",
                            -fCBRearWallXDim / 2. - fCBExtraXDim + fAcrylicWidth + fCBFrontWallXDim / 2.,
                            -fCBFrontWallYDim / 2.,
                            -(fSlopedWallZProj + 2 * (fCBTinyZDim - fAcrylicWidth) + fAcrylicWidth) + fBPolyWidth);
    ...
    TGeoTranslation *CBRearCov12pos = new TGeoTranslation("CBRearCov12pos",
                                                          -fCBRearWallXDim / 2. + fAcrylicWidth / 2.,
                                                          -fCBFrontWallYDim / 2.,
                                                          fAcrylicWidth / 2. + (fCBExtraZDim - 2 * fAcrylicWidth) / 2.);
    CBRearCov12pos->RegisterYourself();
    TGeoTranslation *CBRearCov13pos = new TGeoTranslation("CBRearCov13pos",
                                                          -fCBRearWallXDim / 2. + fAcrylicWidth - fCBExtraXDim / 2.,
                                                          -fCBFrontWallYDim / 2.,
    ...
    // Shapes definition
    TGeoBBox *CBFrontWall_b =
        new TGeoBBox("CBFrontWall_b",
                     fCBFrontWallXDim_b / 2. + (fAcrylicWidth - fBPolyWidth) / 10.,
                     fCBFrontWallYDim_b / 2.,
                     fBPolyWidth / 2.);   // (fAcrylicWidth-fBPolyWidth)/10. is due to approximations, I guess
    TGeoBBox *CBLateral_b = new TGeoBBox("CBLateral_b",
                                         fBPolyWidth / 2.,
                                         fCBFrontWallYDim_b / 2.,
    ...
    TGeoBBox *CBExtraLat_b = new TGeoBBox(
        "CBExtraLat_b", fBPolyWidth / 2., fCBFrontWallYDim_b / 2., (fCBExtraZDim - fAcrylicWidth - fBPolyWidth) / 2.);
    TGeoBBox *CBTiny1_b = new TGeoBBox(
        "CBTiny1_b", fBPolyWidth / 2., fCBFrontWallYDim_b / 2., (fCBTinyZDim - fAcrylicWidth - fBPolyWidth) / 2.);
    TGeoBBox *CBTiny2_b =
    ...
    TGeoArb8 *LatCov21_b =
        new TGeoArb8("LatCov21_b", (fCBTinyZDim - fAcrylicWidth) / 2., (Double_t *)LatCover21_bverts);
    ...
    TGeoTranslation *FrontWallpos_b = new TGeoTranslation(
        "FrontWallpos_b",
        -fCBRearWallXDim_b / 2. - fCBExtraXDim_b + fBPolyWidth + fCBFrontWallXDim_b / 2. + 0.1,
        0,
    ...
    TGeoTranslation *SlopeWallpos_b = new TGeoTranslation(
        "SlopeWallpos_b",
        fSlopedWallZProj / (2 * TMath::Tan(TMath::DegToRad() * 85.)) + fCBRearWallXDim_b / 2. + 3 * fBPolyWidth,
        0,
    ...
    TGeoTranslation *Tiny2pos_b = new TGeoTranslation("Tiny2pos_b",
                                                      ...
                                                      0,
                                                      -fSlopedWallZProj - (fCBTinyZDim - fAcrylicWidth));
    Tiny2pos_b->RegisterYourself();
    TGeoTranslation *CBExtraLatpos_b = new TGeoTranslation(
        "CBExtraLatpos_b", -fCBRearWallXDim_b / 2. + fBPolyWidth / 2., 0, (fCBExtraZDim - fAcrylicWidth) / 2.);
    CBExtraLatpos_b->RegisterYourself();
    TGeoTranslation *CBExtraFrontpos_b =
        new TGeoTranslation("CBExtraFrontpos_b",
                            -fCBRearWallXDim_b / 2. + fBPolyWidth - fCBExtraXDim_b / 2.,
                            0,
                            fCBExtraZDim - fAcrylicWidth);
    CBExtraFrontpos_b->RegisterYourself();
    TGeoTranslation *CBLateralpos_b =
        new TGeoTranslation("CBLateralpos_b",
                            -fCBRearWallXDim_b / 2. - fCBExtraXDim_b + fBPolyWidth + fBPolyWidth / 2.,
                            0,
                            fCBExtraZDim - fCBLatWallZDim_b / 2. + fBPolyWidth / 2. - fAcrylicWidth);
    CBLateralpos_b->RegisterYourself();
    TGeoTranslation *CBLatCov1pos_b =
        new TGeoTranslation("CBLatCov1pos_b",
                            -fCBRearWallXDim / 2. - fCBExtraXDim + 2 * fAcrylicWidth + fBPolyWidth + fAcrylicWidth / 2.,
                            -fCBFrontWallYDim_b / 2.,
                            fCBExtraZDim - fCBLatWallZDim / 2. + fAcrylicWidth / 2 - 0.5);
    ...
    TGeoTranslation *CBLatCov23pos_b =
        new TGeoTranslation("CBLatCov23pos_b",
                            (fCBRearWallXDim - fAcrylicWidth) / 2. - fAcrylicWidth / 2. + fBPolyWidth / 2. + 0.5,
                            -fCBFrontWallYDim_b / 2.,
                            -fCBTinyZDim / 2. + fBPolyWidth + fBPolyWidth / 2. + 0.5);
    CBLatCov23pos_b->RegisterYourself();
    TGeoTranslation *CBFrontCov1pos_b =
        new TGeoTranslation("CBFrontCov1pos_b",
                            -fCBRearWallXDim_b / 2. - fCBExtraXDim_b + fBPolyWidth + fCBFrontWallXDim_b / 2.,
                            -fCBFrontWallYDim_b / 2.,
                            -fSlopedWallZProj - (fCBTinyZDim - fAcrylicWidth + fBPolyWidth));
    ...
    TGeoTranslation *CBRearCov12pos_b =
        new TGeoTranslation("CBRearCov12pos_b",
                            -fCBRearWallXDim_b / 2. + fAcrylicWidth / 2. - 0.5,
                            -fCBFrontWallYDim_b / 2.,
                            fAcrylicWidth / 2. + (fCBExtraZDim - 2 * fAcrylicWidth) / 2.);
    CBRearCov12pos_b->RegisterYourself();
    TGeoTranslation *CBRearCov13pos_b =
        new TGeoTranslation("CBRearCov13pos_b",
                            -fCBRearWallXDim_b / 2. + fAcrylicWidth - fCBExtraXDim / 2 + fBPolyWidth,
                            -fCBFrontWallYDim_b / 2.,
                            fCBExtraZDim - fAcrylicWidth);
    ...
    TGeoBBox *CBRoof2_a = new TGeoBBox("CBRoof2_a",
                                       (fCBRearWallXDim - fAcrylicWidth) / 2.,
                                       fAcrylicWidth / 2.,
                                       (fCBLatWallZDim - fCBExtraZDim + fAcrylicWidth) / 2.);
    TGeoBBox *CBRoof3_a = new TGeoBBox("CBRoof3_a",
                                       (fSlopedWallZProj * (TMath::Tan(TMath::DegToRad() * 15.))) / 2.,
                                       fAcrylicWidth / 2.,
                                       fCBTinyZDim / 2.);
    TGeoArb8 *CBRoof4_a = new TGeoArb8("CBRoof4_a", fSlopedWallZProj / 2., (Double_t *)Roof4_averts);

    TGeoTranslation *Roof1_apos = new TGeoTranslation("Roof1_apos",
                                                      -(fCBRearWallXDim - fAcrylicWidth) / 2. - fCBExtraXDim / 2.,
                                                      0,
                                                      fCBExtraZDim / 2. - fAcrylicWidth / 2.);
    Roof1_apos->RegisterYourself();
    TGeoTranslation *Roof3_apos = new TGeoTranslation(
        "Roof3_apos",
        (fCBRearWallXDim - fAcrylicWidth) / 2. + (fSlopedWallZProj * (TMath::Tan(TMath::DegToRad() * 15.))) / 2.,
        0,
        -(fCBLatWallZDim - fCBExtraZDim + fAcrylicWidth) / 2. + fCBTinyZDim / 2.);
    Roof3_apos->RegisterYourself();
    TGeoTranslation *Roof4_apos = new TGeoTranslation("Roof4_apos",
                                                      (fCBRearWallXDim - fAcrylicWidth) / 2.,
                                                      -fAcrylicWidth / 2.,
                                                      -(fCBLatWallZDim - fCBExtraZDim + fAcrylicWidth) / 2.
                                                          + fCBTinyZDim + fSlopedWallZProj / 2.);
    ...
    TGeoBBox *CBRoof2_b = new TGeoBBox("CBRoof2_b",
                                       (fCBRearWallXDim_b - fBPolyWidth) / 2. + fBPolyWidth / 2.,
                                       fBPolyWidth / 2.,
                                       (fCBLatWallZDim_b - fCBExtraZDim + fAcrylicWidth) / 2.);
    TGeoBBox *CBRoof3_b = new TGeoBBox("CBRoof3_b",
                                       (fSlopedWallZProj * (TMath::Tan(TMath::DegToRad() * 15.))) / 2.,
                                       fBPolyWidth / 2.,
                                       (fCBTinyZDim - fAcrylicWidth) / 2.);
    TGeoArb8 *CBRoof4_b = new TGeoArb8("CBRoof4_b", fSlopedWallZProj / 2., (Double_t *)Roof4_bverts);

    TGeoTranslation *Roof1_bpos = new TGeoTranslation("Roof1_bpos",
                                                      -(fCBRearWallXDim - fAcrylicWidth) / 2. - fCBExtraXDim_b / 2.,
                                                      0,
                                                      fCBExtraZDim / 2. - fAcrylicWidth / 2.);
    ...
    TGeoTranslation *Roof4_bpos = new TGeoTranslation("Roof4_bpos",
                                                      (fCBRearWallXDim - fAcrylicWidth) / 2.,
                                                      -fBPolyWidth / 2.,
                                                      -(fCBLatWallZDim_b - fCBExtraZDim + fAcrylicWidth) / 2.
                                                          + fCBTinyZDim - fAcrylicWidth + fSlopedWallZProj / 2.);
    ...
    volColdBox->AddNode(volCOLDBOXB,
                        0,
                        new TGeoTranslation(-fBPolyWidth - fAcrylicWidth / 2.,
                                            -fBPolyWidth / 2.,
                                            -fAcrylicWidth / 2. - fBPolyWidth / 2.));
    volColdBox->AddNode(
        volCBRoof_a,
        0,
        new TGeoTranslation(fAcrylicWidth / 2.,
                            fCBFrontWallYDim / 2. + fAcrylicWidth / 2.,
                            -(fCBLatWallZDim - fCBExtraZDim + fAcrylicWidth) / 2. + fAcrylicWidth / 2.));
    volColdBox->AddNode(
        volCBRoof_b,
        0,
        new TGeoTranslation(-fAcrylicWidth / 2.,
                            fCBFrontWallYDim / 2. - fBPolyWidth / 2.,
                            -(fCBLatWallZDim - fCBExtraZDim + fAcrylicWidth) / 2. + fAcrylicWidth / 2.));
...
void Floor::Register() { FairRootManager::Instance()->Register("vetoPoint", "veto", fFloorPointCollection, kTRUE); }

TClonesArray *Floor::GetCollection(Int_t iColl) const
{
    if (iColl == 0) {
        return fFloorPointCollection;
    } else {
        return NULL;
    }
}
void Floor::Reset() { fFloorPointCollection->Clear(); }
