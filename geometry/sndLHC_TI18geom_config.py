...
with ConfigRegistry.register_config("basic") as c:
    ...
    # station rotations
    c.Scifi.RotPhiS1, c.Scifi.RotPsiS1, c.Scifi.RotThetaS1 = (
        0.00 * u.mrad,
        -1.00 * u.mrad,
        0.00 * u.mrad,
    )
    c.Scifi.RotPhiS2, c.Scifi.RotPsiS2, c.Scifi.RotThetaS2 = (
        0.00 * u.mrad,
        0.00 * u.mrad,
        0.00 * u.mrad,
    )
    c.Scifi.RotPhiS3, c.Scifi.RotPsiS3, c.Scifi.RotThetaS3 = (
        0.00 * u.mrad,
        0.00 * u.mrad,
        0.00 * u.mrad,
    )
    c.Scifi.RotPhiS4, c.Scifi.RotPsiS4, c.Scifi.RotThetaS4 = (
        0.00 * u.mrad,
        0.00 * u.mrad,
        0.00 * u.mrad,
    )
    c.Scifi.RotPhiS5, c.Scifi.RotPsiS5, c.Scifi.RotThetaS5 = (
        0.00 * u.mrad,
        0.00 * u.mrad,
        0.00 * u.mrad,
    )
