...
void preshower::EndOfEvent() { fpreshowerPointCollection->Clear(); }
...
void preshower::Register()
{
    ...
    */
    ...
    FairRootManager::Instance()->Register("preshowerPoint", "preshower", fpreshowerPointCollection, kTRUE);
}

TClonesArray *preshower::GetCollection(Int_t iColl) const
{
    if (iColl == 0) {
        return fpreshowerPointCollection;
    } else {
        return NULL;
    }
}

void preshower::Reset() { fpreshowerPointCollection->Clear(); }
...
void preshower::SetActiveThickness(Double_t activeThickness) { fActiveThickness = activeThickness; }
...
void preshower::SetXMax(Double_t xMax) { fXMax = xMax; }
void preshower::SetYMax(Double_t yMax) { fYMax = yMax; }
...
preshowerPoint *preshower::AddHit(Int_t trackID,
                                  Int_t detID,
                                  TVector3 pos,
                                  TVector3 mom,
                                  Double_t time,
                                  ...
                                  Int_t pdgCode)
{
    ...
    return new (clref[size]) preshowerPoint(trackID, detID, pos, mom, time, length, eLoss, pdgCode);
}
