...
avgSciFiFiducialCut::avgSciFiFiducialCut(double vertical_min_cut,
    ...
    : sciFiBaseCut(tree)
{
    ...
    cutName = "Avg SciFi Ver channel in [" + std::to_string(vertical_min) + "," + std::to_string(vertical_max)
              + "] Hor in [" + std::to_string(horizontal_min) + "," + std::to_string(horizontal_max) + "]";
...
bool avgSciFiFiducialCut::passCut()
{
    ...
    if (not reversed) {
        if (avg_hor < horizontal_min)
            return false;
        if (avg_hor > horizontal_max)
            return false;
        if (avg_ver < vertical_min)
            return false;
        if (avg_ver > vertical_max)
            return false;
    } else {
        if ((avg_hor > horizontal_min) and (avg_hor < horizontal_max))
            return false;
        if ((avg_ver > vertical_min) and (avg_ver < vertical_max))
            return false;
    }
    return true;
}
