...
EmulsionMagnet::EmulsionMagnet()
    : FairModule("EmulsionMagnet", "")
{
}

EmulsionMagnet::EmulsionMagnet(const char *name, const Double_t zC, const char *Title)
...
void EmulsionMagnet::SetMagneticField(Double_t B) { fField = B; }
...
void EmulsionMagnet::SetConstantField(Bool_t EmuMagnetConstField) { fConstField = EmuMagnetConstField; }
...
void EmulsionMagnet::ConstructGeometry()
{
    ...
    if (fDesign == 0)   // OLD, TP
    {
        ...
        // Coils Description: 2 volumes must be defined being the upper coil in Cu and the lower one in Al and also
        // heghts are different
        ...
        // Each column is made of a longer pillar (rectangle + trapezoid) and on top a shorter pillar (rectangle +
        // trapezoid again)
        ...
        TGeoTranslation *tr1 = new TGeoTranslation(
            -fMagnetX / 2 + side1 / 2, fMagnetY / 2 - fBaseY - fCoilH1 / 2, -fMagnetZ / 2 + base1 / 2);
        ...
        TGeoBBox *LateralSurface1low =
            new TGeoBBox("LateralSurface1low", side1 / 2, (fCoilDist + fCoilH2) / 2, side2 / 2);
        ...
        TGeoTranslation *tr1low = new TGeoTranslation(-fMagnetX / 2 + side1 / 2,
                                                      fMagnetY / 2 - fBaseY - fCoilH1 - (fCoilDist + fCoilH2) / 2,
                                                      -fMagnetZ / 2 + side2 / 2);
        ...
        TGeoBBox *LateralSurface2low =
            new TGeoBBox("LateralSurface2low", side3 / 2, (fCoilDist + fCoilH2) / 2, base2 / 2);
        ...
        TGeoTranslation *tr2low = new TGeoTranslation(-fMagnetX / 2 + side1 + side3 / 2,
                                                      fMagnetY / 2 - fBaseY - fCoilH1 - (fCoilDist + fCoilH2) / 2,
                                                      -fMagnetZ / 2 + base2 / 2);
        ...
        // LONGER RECTANGLE
        TGeoTranslation *tr1_b = new TGeoTranslation(
            -fMagnetX / 2 + side1 / 2, fMagnetY / 2 - fBaseY - fCoilH1 / 2, fMagnetZ / 2 - base1 / 2);
        ...
        TGeoTranslation *tr1blow = new TGeoTranslation(-fMagnetX / 2 + side1 / 2,
                                                       fMagnetY / 2 - fBaseY - fCoilH1 - (fCoilDist + fCoilH2) / 2,
                                                       fMagnetZ / 2 - side2 / 2);
        ...
        TGeoTranslation *tr2blow = new TGeoTranslation(-fMagnetX / 2 + side1 + side3 / 2,
                                                       fMagnetY / 2 - fBaseY - fCoilH1 - (fCoilDist + fCoilH2) / 2,
                                                       fMagnetZ / 2 - base2 / 2);
        ...
        TGeoTranslation *tr1_d = new TGeoTranslation(fMagnetX / 2 - side1 / 2,
                                                     fMagnetY / 2 - fBaseY - (fCoilH1 + fCoilH2 + fCoilDist) / 2,
                                                     -fMagnetZ / 2 + base1 / 2);
        ...
        TGeoCombiTrans tr2_d(
            fMagnetX / 2, fMagnetY / 2 - fBaseY - (fCoilH1 + fCoilH2 + fCoilDist) / 2, -fMagnetZ / 2, r2_d);
        ...
        TGeoTranslation *tr1_c = new TGeoTranslation(fMagnetX / 2 - side1 / 2,
                                                     fMagnetY / 2 - fBaseY - (fCoilH1 + fCoilH2 + fCoilDist) / 2,
                                                     fMagnetZ / 2 - base1 / 2);
        ...
        TGeoCombiTrans tr2_c(
            fMagnetX / 2, fMagnetY / 2 - fBaseY - (fCoilH1 + fCoilH2 + fCoilDist) / 2, fMagnetZ / 2, r2_c);
    ...
    if (fDesign == 1)   // NEW with magnet
    {
        ...
        *m1_l = trans1l;
        ...
        MagnetVol->AddNode(
            ColumnVol, 1, new TGeoTranslation(0, fMagnetY / 2 - fColumnY / 2, -fMagnetZ / 2 + fColumnZ / 2));
        MagnetVol->AddNode(
            ColumnVol, 2, new TGeoTranslation(0, fMagnetY / 2 - fColumnY / 2, fMagnetZ / 2 - fColumnZ / 2));
        MagnetVol->AddNode(
            ColumnVol, 3, new TGeoTranslation(0, -fMagnetY / 2 + fColumnY / 2, -fMagnetZ / 2 + fColumnZ / 2));
        MagnetVol->AddNode(
            ColumnVol, 4, new TGeoTranslation(0, -fMagnetY / 2 + fColumnY / 2, fMagnetZ / 2 - fColumnZ / 2));
        ...
        tTauNuDet->AddNode(PillarVol,
                           1,
                           new TGeoTranslation(-fMagnetX / 2 + fPillarX / 2,
                                               -fMagnetY / 2 - fPillarY / 2,
                                               fCenterZ - fMagnetZ / 2 + fPillarZ / 2));
        tTauNuDet->AddNode(PillarVol,
                           2,
                           new TGeoTranslation(fMagnetX / 2 - fPillarX / 2,
                                               -fMagnetY / 2 - fPillarY / 2,
    ...
    if (fDesign == 3)   // NEW with magnet
    {
        ...
        TGeoBBox *SemiLateralBox =
            new TGeoBBox("SemiLateralBox", (fColumnX) / 2, SemiLateralBoxHeight / 2, fColumnZ / 2);
        TGeoVolume *volUpLateral =
            new TGeoVolume("volUpLateral", SemiLateralBox, Fe);   // up and down refer to the magnetic field verse
        ...
        TGeoTranslation *transcuttop = new TGeoTranslation("transcuttop",
                                                           0,
                                                           fCutHeight / 2 + SemiLateralBoxHeight / 2,
                                                           0);   // top and bottom refer to their geometrical positions
        TGeoTranslation *transcuttop1 = new TGeoTranslation("transcuttop1", 0, MidBoxHeight / 2, 0);
        TGeoTranslation *transcutbottom =
            new TGeoTranslation("transcutbottom", 0, -fCutHeight / 2 - SemiLateralBoxHeight / 2, 0);
        ...
        TGeoCompositeShape *cuttop = new TGeoCompositeShape(
            "CUTTOP", "CUT - (S:transcuttop) - (S:transcutbottom)");   // triangular cut in the right lateral wall
        ...
        TGeoCompositeShape *cuttopleft = new TGeoCompositeShape(
            "CUTTOPLEFT",
            "CUTLEFT - (S:transcuttop) - (S:transcutbottom)");   // triangular cut in the left lateral wall
        ...
        TGeoTubeSeg *Coillateraltuberightdown =
            new TGeoTubeSeg("Coillateraltuberightdown", fCoilThickness, OuterRadius, fCoilX / 2, 90, 180);
        TGeoTubeSeg *Coillateraltuberighttup =
            new TGeoTubeSeg("Coillateraltuberightup", fCoilThickness, OuterRadius, fCoilX / 2, 0, 90);
        TGeoTubeSeg *Coillateraltubeleftup =
            new TGeoTubeSeg("Coillateraltubeleftup", fCoilThickness, OuterRadius, fCoilX / 2, 270, 360);
        TGeoTubeSeg *Coillateraltubeleftdown =
            new TGeoTubeSeg("Coillateraltubeleftdown", fCoilThickness, OuterRadius, fCoilX / 2, 180, 270);

        TGeoBBox *Coillateralcenter =
            new TGeoBBox("Coillateralcenter", fCoilX / 2., (fCoilH2 - 2 * fCoilThickness) / 2, fCoilY / 2.);

        TGeoRotation rottube("rottube", 90, 90, 0);
        // transformations to combine them
        const TGeoTranslation transtube(
            "transtube", 0., -(fCoilH2 - 2 * fCoilThickness) / 2, -fCoilThickness - fCoilY / 2);
        const TGeoTranslation transtube1(
            "transtube1", 0., (fCoilH2 - 2 * fCoilThickness) / 2, -fCoilThickness - fCoilY / 2);
        const TGeoTranslation transtube2(
            "transtube2", 0., -(fCoilH2 - 2 * fCoilThickness) / 2, +fCoilThickness + fCoilY / 2);
        const TGeoTranslation transtube3(
            "transtube3", 0., (fCoilH2 - 2 * fCoilThickness) / 2, +fCoilThickness + fCoilY / 2);
        ...
        TGeoCompositeShape *CoilRight = new TGeoCompositeShape(
            "CoilRight", "Coillateraltuberightdown:combination+Coillateraltuberightup:combination1+Coillateralcenter");
        TGeoVolume *CoilVolright = new TGeoVolume("CoilVolright", CoilRight, Cu);

        TGeoCompositeShape *CoilLeft = new TGeoCompositeShape(
            "CoilLeft", "Coillateraltubeleftdown:combination2+Coillateraltubeleftup:combination3+Coillateralcenter");
        TGeoVolume *CoilVolleft = new TGeoVolume("CoilVolleft", CoilLeft, Cu);

        TGeoBBox *Coil = new TGeoBBox(
            "Coil", fCoilX / 2, fCoilY / 2, (fMagnetZ - 2 * OuterRadius) / 2);   // two times the external radius
        ...
        MagnetVol->AddNode(
            volUpLateral,
            1,
            new TGeoTranslation(-fMagnetX / 2 + fColumnX / 2, (fCutHeight + (fColumnY - fCutHeight) / 2) / 2, 0));
        MagnetVol->AddNode(
            volDownLateral,
            1,
            new TGeoTranslation(-fMagnetX / 2 + fColumnX / 2, (-fCutHeight - (fColumnY - fCutHeight) / 2) / 2, 0));
        ...
        if (fConstField) {   // adding magnetic field if not implemented from nudet field map
            TGeoUniformMagField *magField1 =
                new TGeoUniformMagField(-fField, 0., 0.);   // magnetic field in Magnet pillars
            TGeoUniformMagField *magField2 = new TGeoUniformMagField(fField, 0., 0.);   // magnetic field in target
            TGeoUniformMagField *magField1y =
                new TGeoUniformMagField(0., -fField, 0.);   // down return magnetic field along y
            TGeoUniformMagField *magField2y =
                new TGeoUniformMagField(0., fField, 0.);   // up return magnetic field along y
