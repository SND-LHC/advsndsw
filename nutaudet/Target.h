...
class Target : public FairDetector
{
  public:
    ...
    void SetEmulsionParam(Double_t EmTh,
                          Double_t EmX,
                          Double_t EmY,
                          Double_t PBTh,
                          Double_t EPlW,
                          Double_t LeadTh,
                          Double_t AllPW);
    void SetBrickParam(Double_t BrX,
                       Double_t BrY,
                       Double_t BrZ,
                       Double_t BrPackX,
                       Double_t BrPackY,
    ...
    // Functions to set dimension of both the base and the pillars in no magnet configuration options. The pillars are
    // defined in EmulsionMagnet class in the option with magnet.
    void SetBaseDimension(Double_t X, Double_t Y, Double_t Z);
    void SetPillarDimension(Double_t X, Double_t Y, Double_t Z);

    void DecodeBrickID(Int_t detID,
                       Int_t& NWall,
                       Int_t& NRow,
                       Int_t& NColumn,
                       Int_t& NPlate,
  ...
  protected:
    ...
    Bool_t fsingleemulsionfilm;   // 0 = both top and bottom layers active, separated by plastic base; 1 = only one
                                  // active layer
