...
inline Bool_t ecalStructureFiller::GetUseMCPoints() const { return fUseMCPoints; }
...
inline Bool_t ecalStructureFiller::GetStoreTrackInformation() const { return fStoreTrackInfo; }

inline ecalStructure* ecalStructureFiller::GetStructure() const { return fStr; }
