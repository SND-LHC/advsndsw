...
void muon::EndOfEvent() { fmuonPointCollection->Clear(); }
...
void muon::Register()
{
    ...
    */
    ...
    FairRootManager::Instance()->Register("muonPoint", "muon", fmuonPointCollection, kTRUE);
}

TClonesArray *muon::GetCollection(Int_t iColl) const
{
    if (iColl == 0) {
        return fmuonPointCollection;
    } else {
        return NULL;
    }
}

void muon::Reset() { fmuonPointCollection->Clear(); }
...
void muon::SetActiveThickness(Double_t activeThickness) { fActiveThickness = activeThickness; }
void muon::SetFilterThickness(Double_t filterThickness) { fFilterThickness = filterThickness; }
void muon::SetXMax(Double_t xMax) { fXMax = xMax; }
void muon::SetYMax(Double_t yMax) { fYMax = yMax; }
                        ...
                        Int_t pdgCode)
{
    ...
    return new (clref[size]) muonPoint(trackID, detID, pos, mom, time, length, eLoss, pdgCode);
}
