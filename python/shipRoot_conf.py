...
def configure(darkphoton=None):
    ...
    pdg.AddParticle(
        "J/psi[3PJ(8)]", "J/psi[3PJ(8)]", 3.29692, False, 0.0, 0.0, "Meson", 9942003
    )
    pdg.AddParticle(
        "J/psi[1S0(8)]", "J/psi[1S0(8)]", 3.29692, False, 0.0, 0.0, "Meson", 9941003
    )
    pdg.AddParticle("f0(980)", "f0(980)", 1.0, False, 0.0, 0.0, "Meson", 9010221)
    pdg.AddParticle(
        "psi(3770)", "psi(3770)", 3.77315, False, 0.02720, 0, "Meson", 30443
    )
    pdg.AddParticle(
        "psi(3770)[3PJ(8)]",
        "psi(3770)[3PJ(8)]",
    ...
    pdg.AddParticle(
        "J/psi[3S1(8)]", "J/psi[3S1(8)]", 3.29692, False, 0.0, 0, "Meson", 9940003
    )
    pdg.AddParticle(
        "chi_0c[3S1(8)]", "chi_0c[3S1(8)]", 3.61475, False, 0.0, 0, "Meson", 9940011
    )
    pdg.AddParticle(
        "psi(2S)[1S0(8)]", "psi(2S)[1S0(8)]", 3.88611, False, 0.0, 0, "Meson", 9941103
    )
    pdg.AddParticle(
        "psi(2S)[3S1(8)]", "psi(2S)[3S1(8)]", 3.88611, False, 0.0, 0, "Meson", 9940103
    )
    pdg.AddParticle(
        "psi(2S)[3PJ(8)]", "psi(2S)[3PJ(8)]", 3.88611, False, 0.0, 0, "Meson", 9942103
    )
    pdg.AddParticle(
        "chi_1c[3S1(8)]", "chi_1c[3S1(8)]", 3.71066, False, 0.0, 0, "Meson", 9940023
    )
    pdg.AddParticle(
        "chi_2c[3S1(8)]", "chi_2c[3S1(8)]", 3.75620, False, 0.0, 0, "Meson", 9940005
    )
    pdg.AddParticle(
        "Upsilon[3S1(8)]", "Upsilon[3S1(8)]", 9.66030, False, 0.0, 0, "Meson", 9950003
    )
