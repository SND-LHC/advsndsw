...
sipm_map = (
    ...
    (
        -hw + edge + array + biggap,
        -hw + edge + array + biggap + charr,
        (127.5, 191.5),
    ),  # 2.1
    (
        -hw + edge + array + biggap + charr,
        -hw + edge + array + biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + array + biggap + charr + gap,
        -hw + edge + array + biggap + array,
        (191.5, 255.5),
    ),  # 2.2
    (-hw + edge + 2 * array + biggap, -hw + edge + 2 * array + 2 * biggap, False),
    (
        -hw + edge + 2 * array + 2 * biggap,
        -hw + edge + 2 * array + 2 * biggap + charr,
        (255.5, 319.5),
    ),  # 3.1
    (
        -hw + edge + 2 * array + 2 * biggap + charr,
        -hw + edge + 2 * array + 2 * biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + 2 * array + 2 * biggap + charr + gap,
        -hw + edge + 2 * array + 2 * biggap + array,
        (319.5, 383.5),
    ),  # 3.2
    (-hw + edge + 3 * array + 2 * biggap, -hw + edge + 3 * array + 3 * biggap, False),
    (
        -hw + edge + 3 * array + 3 * biggap,
        -hw + edge + 3 * array + 3 * biggap + charr,
        (383.5, 447.5),
    ),  # 4.1
    (
        -hw + edge + 3 * array + 3 * biggap + charr,
        -hw + edge + 3 * array + 3 * biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + 3 * array + 3 * biggap + charr + gap,
        -hw + edge + 3 * array + 3 * biggap + array,
        (447.5, 511.5),
    ),  # 4.2
    (-hw + edge + 4 * array + 3 * biggap, -hw + edge + 4 * array + 4 * biggap, False),
    (
        -hw + edge + 4 * array + 4 * biggap,
        -hw + edge + 4 * array + 4 * biggap + charr,
        (511.5, 575.5),
    ),  # 5.1
    (
        -hw + edge + 4 * array + 4 * biggap + charr,
        -hw + edge + 4 * array + 4 * biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + 4 * array + 4 * biggap + charr + gap,
        -hw + edge + 4 * array + 4 * biggap + array,
        (575.5, 639.5),
    ),  # 5.2
    (-hw + edge + 5 * array + 4 * biggap, -hw + edge + 5 * array + 5 * biggap, False),
    (
        -hw + edge + 5 * array + 5 * biggap,
        -hw + edge + 5 * array + 5 * biggap + charr,
        (639.5, 703.5),
    ),  # 6.1
    (
        -hw + edge + 5 * array + 5 * biggap + charr,
        -hw + edge + 5 * array + 5 * biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + 5 * array + 5 * biggap + charr + gap,
        -hw + edge + 5 * array + 5 * biggap + array,
        (703.5, 767.5),
    ),  # 6.2
    (-hw + edge + 6 * array + 5 * biggap, -hw + edge + 6 * array + 6 * biggap, False),
    (
        -hw + edge + 6 * array + 6 * biggap,
        -hw + edge + 6 * array + 6 * biggap + charr,
        (767.5, 831.5),
    ),  # 7.1
    (
        -hw + edge + 6 * array + 6 * biggap + charr,
        -hw + edge + 6 * array + 6 * biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + 6 * array + 6 * biggap + charr + gap,
        -hw + edge + 6 * array + 6 * biggap + array,
        (831.5, 895.5),
    ),  # 7.2
    (-hw + edge + 7 * array + 6 * biggap, -hw + edge + 7 * array + 7 * biggap, False),
    (
        -hw + edge + 7 * array + 7 * biggap,
        -hw + edge + 7 * array + 7 * biggap + charr,
        (895.5, 959.5),
    ),  # 8.1
    (
        -hw + edge + 7 * array + 7 * biggap + charr,
        -hw + edge + 7 * array + 7 * biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + 7 * array + 7 * biggap + charr + gap,
        -hw + edge + 7 * array + 7 * biggap + array,
        (959.5, 1023.5),
    ),  # 8.2
    (-hw + edge + 8 * array + 7 * biggap, -hw + edge + 8 * array + 8 * biggap, False),
    (
        -hw + edge + 8 * array + 8 * biggap,
        -hw + edge + 8 * array + 8 * biggap + charr,
        (1023.5, 1087.5),
    ),  # 9.1
    (
        -hw + edge + 8 * array + 8 * biggap + charr,
        -hw + edge + 8 * array + 8 * biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + 8 * array + 8 * biggap + charr + gap,
        -hw + edge + 8 * array + 8 * biggap + array,
        (1087.5, 1151.5),
    ),  # 9.2
    (-hw + edge + 9 * array + 8 * biggap, -hw + edge + 9 * array + 9 * biggap, False),
    (
        -hw + edge + 9 * array + 9 * biggap,
        -hw + edge + 9 * array + 9 * biggap + charr,
        (1151.5, 1215.5),
    ),  # 10.1
    (
        -hw + edge + 9 * array + 9 * biggap + charr,
        -hw + edge + 9 * array + 9 * biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + 9 * array + 9 * biggap + charr + gap,
        -hw + edge + 9 * array + 9 * biggap + array,
        (1215.5, 1279.5),
    ),  # 10.2
    (
        -hw + edge + 10 * array + 9 * biggap,
        -hw + edge + 10 * array + 10 * biggap,
        False,
    ),
    (
        -hw + edge + 10 * array + 10 * biggap,
        -hw + edge + 10 * array + 10 * biggap + charr,
        (1279.5, 1343.5),
    ),  # 11.1
    (
        -hw + edge + 10 * array + 10 * biggap + charr,
        -hw + edge + 10 * array + 10 * biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + 10 * array + 10 * biggap + charr + gap,
        -hw + edge + 10 * array + 10 * biggap + array,
        (1343.5, 1407.5),
    ),  # 11.2
    (
        -hw + edge + 11 * array + 10 * biggap,
        -hw + edge + 11 * array + 11 * biggap,
        False,
    ),
    (
        -hw + edge + 11 * array + 11 * biggap,
        -hw + edge + 11 * array + 11 * biggap + charr,
        (1407.5, 1471.5),
    ),  # 12.1
    (
        -hw + edge + 11 * array + 11 * biggap + charr,
        -hw + edge + 11 * array + 11 * biggap + charr + gap,
        False,
    ),
    (
        -hw + edge + 11 * array + 11 * biggap + charr + gap,
        -hw + edge + 11 * array + 11 * biggap + array,
        (1471.5, 1535.5),
    ),  # 12.2
)
...
ly_CDF_params = {
    (4.5, 13): ((-13.2, 1.976), lambda ly, *p: exp(p[0] + p[1] * sqrt(ly))),
    (13, 104): (
...
CDF_ly_params = {
    (0.0, 0.0006): (
        (89.0, 4.152, 0.0001574, -1.326e04, 4.3),
    ...
    (0.012, 0.018561405): (
        ...
        lambda cdf, *p: p[0] * log((p[1] - p[2] * cdf) / (p[1] + p[2] * cdf))
        + p[3] * cdf
        + p[4],
    ),
    (0.018561405, 0.0185640424): (
        (9.36, 335.984, -18100, -400, 15),
        lambda cdf, *p: (
            p[0] * log((p[1] - p[2] * 0.018561405) / (p[1] + p[2] * 0.018561405))
            + p[3] * 0.018561405
            + p[4]
        ),
    ),
...
def ly_loss_mean(distance, params=ly_loss_params):
    ...
    A1, k1, A2, k2 = params
    return A1 * exp(k1 * distance / 100.0) + A2 * exp(k2 * distance / 100.0)
...
def ly_attenuation(distance):
    ...
    res_ly_loss = ly_loss_mean(distance) / ly_loss_mean(0.0)
    return res_ly_loss
...
def edep_to_ly(
    ...
    if e_min < energy < e_max:
        ...
        cdf_raw = CDF_integral * np.random.uniform(0.0, 1.0)
    else:
        return 0.0
...
def is_realistic(cluster, width):
    ...
    cluster_only_values = [
        (channel, value) for channel, value in enumerate(cluster) if value > 0
    ]
...
def fcheck_wall(cluster, wmp):
    ...
    if (wmp + 0.5) <= firstmatgap_startch:  # 1st mat
        for chann in cluster:
            if cluster[(chann + 0.5) > firstmatgap_startch] != 0.0:
                cluster[chann] = 0.0
            return cluster
    elif firstmatgap_endch <= (wmp + 0.5) <= secmatgap_startch:  # 2nd mat
        for chann in cluster:
            if (cluster[(chann + 0.5) < firstmatgap_endch] != 0.0) or (
                cluster[(chann + 0.5) > secmatgap_startch] != 0.0
            ):
                cluster[chann] = 0.0
            return cluster
    elif (wmp + 0.5) >= secmatgap_endch:  # 3rd mat
        for chann in cluster:
            if cluster[(chann + 0.5) < secmatgap_endch] != 0.0:
                cluster[chann] = 0.0
            return cluster
    else:
...
class ScifiCluster:
    ...
    def ClusterGen(self, Print=False):
        if GetMatType(self.DetID) is False:
            ...
            if Print:
                print("Detector ID -> " + str(self.DetID) + " -> Vertical")
            ...
            if Print:
                print("Detector ID -> " + str(self.DetID) + " -> Horizontal")
        self.matnum = GetMatNum(self.DetID)
        nmats = GetMatQty()
        matlen = GetMatLength()
        self.station = GetStationNum(self.DetID)
        if Print:
            print("First coordinate = " + str(first_coord))
        localpos = global_to_local(self.DetID, first_coord)
        if Print:
            print("Local Pos = " + str(localpos))

        if sipm_pos == +1:
            distance = GetMatLength() / 2.0 - second_coord
        elif sipm_pos == -1:
            distance = GetMatLength() / 2.0 + second_coord

        channelpos = cm_to_channel(localpos, reverse=is_sipm_reversed)

        self.ly = int(round(edep_to_ly(self.Edep) * ly_attenuation(distance)))
        ...
        if Print:
            print("Cluster width: " + str(cluster_width))
        if Print:
            print("Channel position: " + str(channelpos))
        ...
        if Print:
            print("Position readout by the SiPMs => " + str(self.recovery_globalpos))
