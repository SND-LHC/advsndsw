        ...
        for t1 in PosDirCharge:
            ...
            for t2 in PosDirCharge:
                ...
                while dz > 0.01:
                    ...
                    for tr in [t1, t2]:
                        try:
                            ...
                            break
                        self.newPosDir[tr] = {
                            "position": PosDirCharge[tr]["rep"].getPos(
                                PosDirCharge[tr]["newstate"]
                            ),
                            "direction": PosDirCharge[tr]["rep"].getDir(
                                PosDirCharge[tr]["newstate"]
                            ),
                            "momentum": PosDirCharge[tr]["rep"].getMom(
                                PosDirCharge[tr]["newstate"]
                            ),
                        }
                    if not rc:
                ...
                def getP(fitValues, cov, m1, m2):
                    ...
                    M_AtoP[3][0] = (
                        -2 * a6 / a5a8 + 2 * a3 * E2 / (a5 * a5 * A5 * E1)
                    ) / MM
                    M_AtoP[3][1] = (
                        -2 * a7 / a5a8 + 2 * a4 * E2 / (a5 * a5 * A5 * E1)
                    ) / MM
                    M_AtoP[3][2] = (
                    ...
                    M_AtoP[3][3] = (
                        -2 * a3 / a5a8 + 2 * a6 * E1 / (a8 * a8 * A8 * E2)
                    ) / MM
                    M_AtoP[3][4] = (
                        -2 * a4 / a5a8 + 2 * a7 * E1 / (a8 * a8 * A8 * E2)
                    ) / MM
                    M_AtoP[3][5] = (
