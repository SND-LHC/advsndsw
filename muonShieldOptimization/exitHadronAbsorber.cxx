...
void exitHadronAbsorber::EndOfEvent() { fexitHadronAbsorberPointCollection->Clear(); }
...
void exitHadronAbsorber::PreTrack()
{
    ...
    if (idabs < 18 || idabs == 22 || idabs == 111 || idabs == 221 || idabs == 223 || idabs == 331 || idabs == 211
        || idabs == 321 || idabs == 2212) {
        ...
        if (fSkipNeutrinos && (idabs == 12 or idabs == 14 or idabs == 16)) {
            gMC->StopTrack();
        }
    }
}
...
void exitHadronAbsorber::Register()
{
    ...
    FairRootManager::Instance()->Register("vetoPoint", "veto", fexitHadronAbsorberPointCollection, kTRUE);
}

TClonesArray* exitHadronAbsorber::GetCollection(Int_t iColl) const
{
    if (iColl == 0) {
        return fexitHadronAbsorberPointCollection;
    } else {
        return NULL;
    }
}
void exitHadronAbsorber::Reset() { fexitHadronAbsorberPointCollection->Clear(); }
