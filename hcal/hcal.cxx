...
void hcal::FinishPrimary() { fFirstNumber = fLiteCollection->GetEntriesFast(); }
    ...
    if (fELoss > 0) {
        ...
        */
        if (fSimpleGeo == 0) {
            ...
            layer--;
            gMC->CurrentVolOffID(1, mx);
            mx--;
            gMC->CurrentVolOffID(2, my);
            my--;
        }
...
Bool_t hcal::FillLitePoint(Int_t volnum)
{
    ...
    while (part->GetFirstMother() >= 0 && part->Vz() >= zmin && part->Vz() <= zmax && TMath::Abs(part->Vx()) <= xhcal
           && TMath::Abs(part->Vy()) <= yhcal) {
...
void hcal::CopyClones(TClonesArray* cl1, TClonesArray* cl2, Int_t offset)
{
    ...
    if (cl1->GetClass() == hcalPoint::Class()) {
        ...
        cout << "-I- hcal: " << cl2->GetEntriesFast() << " merged entries." << endl;
                        ...
                        Int_t pdgcode)
{
    ...
    return new (clref[size]) hcalPoint(trackID, detID, pos, mom, time, length, eLoss, pdgcode);
}
// -------------------------------------------------------------------------
...
void hcal::ConstructTile(Int_t material)
{
    ...
    switch (material) {
        case 0:
            ...
            break;
        case 1:
            thickness = fThicknessAbsorber / 2.0;
            break;
        case 2:
...
Bool_t hcal::GetCellCoordInf(Int_t fVolID, Float_t& x, Float_t& y, Int_t& section)
{
    ...
    x = mx * modulesize - xcalosize / 2.0 + 1.0;
    x += dx;
    y = my * modulesize - ycalosize / 2.0 + 1.0;
    y += dy;
