...
inline Bool_t hcalStructureFiller::GetUseMCPoints() const { return fUseMCPoints; }
...
inline Bool_t hcalStructureFiller::GetStoreTrackInformation() const { return fStoreTrackInfo; }

inline hcalStructure* hcalStructureFiller::GetStructure() const { return fStr; }
