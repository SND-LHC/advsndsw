...
void ShipBFieldMap::readMapFile()
{
    ...
    std::cout << "ShipBFieldMap::readMapFile() creating field " << this->GetName() << " using file " << mapFileName_
              << std::endl;
...
void ShipBFieldMap::readTextFile()
{
    ...
    getData >> tmpString >> xMin_ >> xMax_ >> dx_ >> yMin_ >> yMax_ >> dy_ >> zMin_ >> zMax_ >> dz_;
...
void ShipBFieldMap::setLimits()
{
    ...
    std::cout << "Total number of bins = " << N_ << "; Nx = " << Nx_ << ", Ny = " << Ny_ << ", Nz = " << Nz_
              << std::endl;
}
