...
ShipCompField::ShipCompField(const std::string& label, TVirtualMagField* firstField)
...
ShipCompField::ShipCompField(const std::string& label, TVirtualMagField* firstField, TVirtualMagField* secondField)
    : TVirtualMagField(label.c_str())
    , theFields_()
{
    theFields_.push_back(firstField);
...
ShipCompField::ShipCompField(const std::string& label, const std::vector<TVirtualMagField*>& theFields)
    : TVirtualMagField(label.c_str())
