...
ShipMagnet::ShipMagnet(const char *name,
                       const char *Title,
                       Double_t z,
                       Int_t c,
                       Double_t dx,
...
TGeoVolume *ShipMagnet::MagnetSupport(Double_t hwidth,
                                      Double_t hheight,
                                      Double_t dz,
                                      Int_t colour,
                                      TGeoMedium *material)
{
    ...
    TGeoRotation *r = new TGeoRotation("r");
    r->RotateY(90.);
    r->RegisterYourself();

    TGeoCompositeShape *TS =
        new TGeoCompositeShape("TS", "ms-FL1-FL2-FL3-FL4-FL5-FL6-SL1:r-SL2:r-SL3:r-SL4:r-SL5:r-SL6:r");
...
void ShipMagnet::ConstructGeometry()
{
    ...
    if (fDesign == 1) {
        ...
        if (fDesign == 2) {
            ...
            TGeoEltu *C1 =
                new TGeoEltu("C1", fDx - 0.3 * m, bradius + 0.2 * m, Yokel + 0.601 * m + magnetIncrease / 2.);
            TGeoBBox *Box1 = new TGeoBBox("Box1", 1. * m, bradius + 0.51 * m, Yokel + 0.61 * m + magnetIncrease / 2.);
            TGeoBBox *Box2 =
                new TGeoBBox("Box2", fDx + 0.01 * m, bradius - 0.5 * m, Yokel + 0.01 * m + magnetIncrease / 2.);
            ...
            TGeoBBox *C1 =
                new TGeoBBox("C1", fDx - 0.3 * m, bradius + 0.2 * m, Yokel + 0.601 * m + magnetIncrease / 2.);
        ...
        TGeoTranslation *t1 = new TGeoTranslation("t1", xaperture, yaperture - CoilThick, 0.);
        t1->RegisterYourself();
        TGeoTranslation *t2 = new TGeoTranslation("t2", -xaperture, yaperture - CoilThick, 0.);
        t2->RegisterYourself();
        ...
        TGeoTranslation *b1 = new TGeoTranslation("b1", xaperture, -yaperture + CoilThick, 0.);
        b1->RegisterYourself();
        TGeoTranslation *b2 = new TGeoTranslation("b2", -xaperture, -yaperture + CoilThick, 0.);
        b2->RegisterYourself();
        ...
        tMagnet->AddNode(
            CV, 1, new TGeoTranslation(xaperture + YokeWidth / 2., 0, fSpecMagz - YokeDepth - CoilThick / 2.));
        tMagnet->AddNode(
            CV, 2, new TGeoTranslation(-xaperture - YokeWidth / 2., 0, fSpecMagz - YokeDepth - CoilThick / 2.));
        tMagnet->AddNode(
            CV, 3, new TGeoTranslation(xaperture + YokeWidth / 2., 0, fSpecMagz + YokeDepth + CoilThick / 2.));
        tMagnet->AddNode(
            CV, 4, new TGeoTranslation(-xaperture - YokeWidth / 2., 0, fSpecMagz + YokeDepth + CoilThick / 2.));
    }
}
