...
{
  public:
    ShipTAUMagneticSpectrometer(const char* name,
                                const Double_t zLS,
                                const Double_t FeL,
                                const Double_t AirL,
    ...
    ClassDef(ShipTAUMagneticSpectrometer, 1)
        ...
        protected : Double_t zLastSlab;   // z distance of the center of the last Fe slab of the second spectrometer in
                                          // cm from the center of the vacuum tube
    Double_t IronLenght;
