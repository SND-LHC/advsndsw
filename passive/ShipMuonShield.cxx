...
ShipMuonShield::ShipMuonShield(TString geofile,
                               const Int_t withCoMagnet,
                               const Bool_t StepGeo,
                               const Bool_t WithConstAbsorberField,
    ...
    : FairModule(name, Title)
{
    ...
    if (fDesign == 5 || fDesign == 6) {
        ...
        dXgap = gap;
        fMuonShieldLength =
            2 * (dZ1 + dZ2 + dZ3 + dZ4 + dZ5 + dZ6 + dZ7 + dZ8) + LE;   // leave some space for nu-tau detector
    }
                                ...
                                Double_t z_translation)
{
    ...
    tShield->AddNode(absorber, 1, new TGeoTranslation(x_translation, y_translation, z_translation));
}
                                ...
                                Bool_t stepGeo)
{
    ...
    for (int i = 0; i < zParts; ++i) {
        for (int k = 0; k < 4; ++k) {
            finalCorners[i][8 + 2 * k] = finalCorners[i][0 + 2 * k] =
                (finalCorners[i][0 + 2 * k] + finalCorners[i][8 + 2 * k]) / 2.0;
            finalCorners[i][9 + 2 * k] = finalCorners[i][1 + 2 * k] =
                (finalCorners[i][9 + 2 * k] + finalCorners[i][1 + 2 * k]) / 2.0;
        }
    }
    ...
    for (int i = 0; i < zParts; ++i) {
        magF.push_back(
            gGeoManager->MakeArb8(arbName + '_' + std::to_string(i), medium, dZp - 0.00001 * m, finalCorners[i]));
                                  ...
                                  Bool_t stepGeo)
{
    ...
    std::array<Double_t, 16> cornersMainL = {middleGap,
                                             -(dY + dX - anti_overlap),
                                             middleGap,
                                             dY + dX - anti_overlap,
                                             dX + middleGap,
    ...
    std::array<Double_t, 16> cornersMainSideL = fDesign <= 7 ? std::array<Double_t, 16>{dX + middleGap + gap,
                                                                                        -HmainSideMag,
                                                                                        dX + middleGap + gap,
                                                                                        HmainSideMag,
                                                                                        2 * dX + middleGap + gap,
                                                                                        ...
                                                                                        2 * dX2 + middleGap2 + gap2,
                                                                                        -HmainSideMag2}
                                                             : std::array<Double_t, 16>{dX + middleGap + gap,
                                                                                        -(dY - anti_overlap),
                                                                                        dX + middleGap + gap,
                                                                                        dY - anti_overlap,
                                                                                        2 * dX + middleGap + gap,
    ...
    std::array<Double_t, 16> cornersMainR, cornersCLBA, cornersMainSideR, cornersCLTA, cornersCRBA, cornersCRTA,
        cornersTR, cornersBL, cornersBR;
                                 ...
                                 std::vector<Double_t> &Z)
{
    ...
    if (fDesign == 8) {
        ...
        dXIn[7] = 0.31 * m;
        dYIn[7] = 1.86 * m;
        dXOut[7] = 0.9 * m - clip_width;
        dYOut[7] = 3.1 * m;
        Double_t clip_len = (dZ8 - zgap / 2) * (1 - (dXOut[7] - dXIn[7]) / (dXOut[7] + clip_width - dXIn[7]));
        gapIn[7] = 0.02 * m;
        gapOut[7] = 0.55 * m;
        ...
        midGapIn[0] = 0;
        midGapOut[0] = 0;
        HmainSideMagIn[0] = dYIn[0];
        HmainSideMagOut[0] = dYOut[0];
        gapIn[0] = 20;
        gapOut[0] = 20;
        dZ[0] = dZ1 - zgap;
        Z[0] = zEndOfAbsorb + dZ[0] + zgap;
        ...
        midGapIn[1] = 0;
        midGapOut[1] = 0;
        HmainSideMagIn[1] = dYIn[1] / 2;
        HmainSideMagOut[1] = dYOut[1] / 2;
        gapIn[1] = 88;
        gapOut[1] = 122;
        dZ[1] = dZ2 - zgap / 2;
        Z[1] = Z[0] + dZ[0] + dZ[1] + zgap;
        ...
        midGapIn[2] = 0;
        midGapOut[2] = 0;
        HmainSideMagIn[2] = dYIn[2] / 2;
        HmainSideMagOut[2] = dYOut[2] / 2;
        gapIn[2] = 0;
        gapOut[2] = 0;
        dZ[2] = dZ3 - zgap / 2;
        Z[2] = Z[1] + dZ[1] + dZ[2] + zgap;
        ...
        midGapIn[3] = 0;
        midGapOut[3] = 0;
        HmainSideMagIn[3] = dXIn[3];
        HmainSideMagOut[3] = dXOut[3];
        gapIn[3] = 0;
        gapOut[3] = 25;
        dZ[3] = dZ4 - zgap / 2;
        Z[3] = Z[2] + dZ[2] + dZ[3] + zgap;
        ...
        midGapIn[4] = 5;
        midGapOut[4] = 25;
        HmainSideMagIn[4] = dXIn[4];
        HmainSideMagOut[4] = dXOut[4];
        gapIn[4] = 20;
        gapOut[4] = 20;
        dZ[4] = dZ6 - zgap / 2;
        Z[4] = Z[3] + dZ[3] + dZ[4] + zgap;
        ...
        midGapIn[5] = 25;
        midGapOut[5] = 65;
        HmainSideMagIn[5] = dXIn[5];
        HmainSideMagOut[5] = dXOut[5];
        gapIn[5] = 20;
        gapOut[5] = 20;
        dZ[5] = dZ7 - zgap / 2;
        Z[5] = Z[4] + dZ[4] + dZ[5] + zgap;
        ...
        midGapIn[6] = 65;
        midGapOut[6] = 75;
        HmainSideMagIn[6] = dXIn[6];
        HmainSideMagOut[6] = dXOut[6];
        gapIn[6] = 20;
        gapOut[6] = 20;
        dZ[6] = dZ8 - zgap / 2;
        Z[6] = Z[5] + dZ[5] + dZ[6] + zgap;
...
void ShipMuonShield::ConstructGeometry()
{
    ...
    if (fDesign >= 5 && fDesign <= 9) {
        ...
        std::vector<FieldDirection> fieldDirection;
        std::vector<Double_t> dXIn, dYIn, dXOut, dYOut, dZf, midGapIn, midGapOut, HmainSideMagIn, HmainSideMagOut,
            gapIn, gapOut, Z;
        ...
        if (fDesign == 6) {
            ...
            CreateMagnet("AbsorberStop-1",
                         ...
                         0,
                         0,
                         zEndOfAbsorb - 5. * dZ0 / 3.,
                         0,
                         false);
            CreateMagnet("AbsorberStop-2",
                         iron,
                         tShield,
                         fields,
                         FieldDirection::up,
                         ...
                         0,
                         0,
                         zEndOfAbsorb - 2. * dZ0 / 3.,
                         0,
                         false);
            TGeoBBox *fullAbsorber = new TGeoBBox("fullAbsorber", dA, dA, dZ0 / 3.);
            TGeoBBox *cutOut = new TGeoBBox(
                "cutout", dA / 3. + 20 * cm, dA / 3. + 20 * cm, dZ0 / 3. + 0.1 * mm);   // no idea why to add 20cm
            ...
            const std::vector<TString> absorber_magnets = (fDesign == 7)
                                                              ? std::vector<TString>{"MagnAbsorb1", "MagnAbsorb2"}
                                                              : std::vector<TString>{"MagnAbsorb2"};
	  ...
	  "_MagTopLeft", "_MagTopRight", "_MagBotLeft", "_MagBotRight",
            ...
            for (auto &&magnet_component : magnet_components) {
                ...
                absorber_magnet_components +=
                    ("-" + absorber_magnets[0] + magnet_component + ":" + mag_trans[0]->GetName());
                if (fDesign == 7) {
                    absorber_magnet_components +=
                        ("-" + absorber_magnets[1] + magnet_component + ":" + mag_trans[1]->GetName());
                }
            }
            TGeoCompositeShape *absorberShape =
                new TGeoCompositeShape("Absorber", "absorber" + absorber_magnet_components);   // cutting out
                                                                                               // magnet parts
                                                                                               // from absorber
            TGeoVolume *absorber = new TGeoVolume("AbsorberVol", absorberShape, iron);
            absorber->SetLineColor(42);   // brown / light red
            tShield->AddNode(
                absorber, 1, new TGeoTranslation(0, 0, zEndOfAbsorb + absorber_half_length + absorber_offset));
            ...
            if (fDesign > 7) {
                ...
                tShield->AddNode(
                    coat, 1, new TGeoTranslation(0, 0, zEndOfAbsorb + absorber_half_length + absorber_offset));
                TGeoVolume *coatWall =
                    gGeoManager->MakeBox("CoatWall", concrete, 10 * m - 1 * mm, 10 * m - 1 * mm, 7 * cm - 1 * mm);
                coatWall->SetLineColor(kRed);
                tShield->AddNode(
                    coatWall,
                    1,
                    new TGeoTranslation(0, 0, zEndOfAbsorb + 2 * absorber_half_length + absorber_offset + 7 * cm));
            }
            ...
            if (fWithCoMagnet > 0) {
                ...
                fieldScale.fill((fField * lengthSum - 2.2 * dZf[fWithCoMagnet]) / fField
                                / (lengthSum - dZf[fWithCoMagnet]));
                fieldScale[0] = 1.;
                fieldScale[1] = 1.;
                try {
            ...
            for (Int_t nM = 2; nM <= (nMagnets - 1); nM++) {
                ...
                Double_t slope = (dYIn[nM] + dXIn[nM] - dYOut[nM] - dXOut[nM]) / (2 * dZf[nM]);
                ...
                if (!fStepGeo) {
                    ...
                    TGeoVolume *pillar1 = gGeoManager->MakeArb8(
                        TString::Format("pillar_%d", 2 * nM - 1), steel, length, verticesIn.data());
                    TGeoVolume *pillar2 =
                        gGeoManager->MakeArb8(TString::Format("pillar_%d", 2 * nM), steel, length, verticesOut.data());
                    pillar1->SetLineColor(kGreen - 5);
                    pillar2->SetLineColor(kGreen - 5);
                    tShield->AddNode(pillar1,
                                     1,
                                     new TGeoTranslation(
                                         0, -0.5 * (dYIn[nM] + dXIn[nM] + 10 * m - fFloor), Z[nM] - dZf[nM] + length));
                    tShield->AddNode(pillar2,
                                     1,
                                     new TGeoTranslation(0,
                                                         -0.5 * (dYOut[nM] + dXOut[nM] + 10 * m - fFloor),
                                                         Z[nM] + dZf[nM] - length));
                }
            }
        ...
        if (fDesign >= 7 && fFloor > 0) {
            ...
            TGeoBBox *box5 = new TGeoBBox("shield_floor",
                                          10 * m,
                                          fFloor / 2.,
            ...
            top->AddNode(floor,
                         ...
                         new TGeoTranslation(0,
                                             -10 * m + fFloor / 2.,
                                             zEndOfAbsorb + fMuonShieldLength / 2. + dZ
                                                 + 14.2 * cm));   // avoiding overlap with CoatWall
        }
