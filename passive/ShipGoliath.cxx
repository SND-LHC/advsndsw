...
ShipGoliath::ShipGoliath(const char *name,
                         const Double_t zC,
                         const Double_t LS,
                         const Double_t TS,
                         const Double_t GapTS,
                         const char *Title)
...
{
    Double_t side1 = TransversalSize,
             side2 = LongitudinalSize;              // side1 = short side, side2 = long side of the top part
    ...
    TGeoCompositeShape *LateralSurfacelow =
        new TGeoCompositeShape("LateralSurfacelow", "LateralSurface1low:tr1low+LateralSurface2low:tr2low");
    ...
    TGeoTranslation *tr2dlow =
        new TGeoTranslation(-side1 / 2 + (side4 - side3) / 2 + side3, -15, zCenter + side2 / 2 - base2 / 2);
    tr2dlow->SetName("tr2dlow");
    tr2dlow->RegisterYourself();

    TGeoCompositeShape *LateralSurfacedlow =
        new TGeoCompositeShape("LateralSurfacedlow", "LateralSurface1dlow:tr1dlow+LateralSurface2dlow:tr2dlow");
