...
class MaterialEffects
{
  ...
  public:
    ...
    double effects(const std::vector<genfit::RKStep>& steps,
     ...
     *
     * The stepper returns the maximum length that the particle may travel, so that a specified relative momentum loss
     * will not be exceeded, or the next material boundary is reached. The material crossed are stored together with
     * their stepsizes.
     */
