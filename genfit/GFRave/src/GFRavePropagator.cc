...
GFRavePropagator* GFRavePropagator::copy() const
{
...
std::pair<rave::Track, double> GFRavePropagator::to(const rave::Track& orig, const ravesurf::Cylinder& rcyl) const
{
...
std::pair<rave::Track, double> GFRavePropagator::to(const rave::Track& orig, const ravesurf::Plane& rplane) const
{
...
rave::Track GFRavePropagator::closestTo(const rave::Track& orig, const rave::Point3D& pt, bool transverse) const
{
...
void GFRavePropagator::setIdGFTrackStateMap(std::map<int, genfit::trackAndState>* map)
{
