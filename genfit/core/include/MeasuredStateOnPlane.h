...
class MeasuredStateOnPlane : public StateOnPlane
{
  ...
  public:
    ...
    MeasuredStateOnPlane(const TVectorD& state,
 ...
 */
MeasuredStateOnPlane calcAverageState(const MeasuredStateOnPlane& forwardState,
...
inline MeasuredStateOnPlane::MeasuredStateOnPlane(const TVectorD& state,
                                                  const TMatrixDSym& cov,
