...
class AbsMeasurement : public TObject
{
  ...
  public:
    ...
    AbsMeasurement(const TVectorD& rawHitCoords,
     ...
     * Usually the vector will contain only one element. But in the case of e.g. a WireMeasurement, it will be 2 (left
     * and right).
     */
  ...
  private:
    ...
    AbsMeasurement& operator=(
        const AbsMeasurement&);   // default cannot work because TVector and TMatrix = operators don't do resizing
