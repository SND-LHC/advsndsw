...
class KalmanFittedStateOnPlane : public MeasuredStateOnPlane
{
  ...
  public:
    ...
    KalmanFittedStateOnPlane(const TVectorD& state,
...
inline KalmanFittedStateOnPlane::KalmanFittedStateOnPlane()
    ...
    , chiSquareIncrement_(0)
    , ndf_(0)
{
    ;
}

inline KalmanFittedStateOnPlane::KalmanFittedStateOnPlane(const TVectorD& state,
                                                          const TMatrixDSym& cov,
                                                          const SharedPlanePtr& plane,
                                                          const AbsTrackRep* rep,
                                                          double chiSquareIncrement,
    ...
    , chiSquareIncrement_(chiSquareIncrement)
    , ndf_(ndf)
{
    ;
}
...
inline KalmanFittedStateOnPlane::KalmanFittedStateOnPlane(const TVectorD& state,
                                                          ...
                                                          double chiSquareIncrement,
                                                          double ndf)
    : MeasuredStateOnPlane(state, cov, plane, rep, auxInfo)
    , chiSquareIncrement_(chiSquareIncrement)
    , ndf_(ndf)
{
    ;
...
inline KalmanFittedStateOnPlane::KalmanFittedStateOnPlane(const MeasuredStateOnPlane& state,
                                                          double chiSquareIncrement,
                                                          double ndf)
