...
RectangularFinitePlane::RectangularFinitePlane(const double& umin,
                                               const double& umax,
                                               const double& vmin,
                                               const double& vmax)
    : uMin_(umin)
...
RectangularFinitePlane::RectangularFinitePlane()
    ...
    , uMax_(-1.)
    , vMin_(1.)
    , vMax_(-1.)   // for this default ctor inActive always false
{
}
...
{
    std::cout << "Rectangular Finite Plane Umin=" << uMin_ << ", Umax=" << uMax_ << ", Vmin=" << vMin_
              << ", Vmax=" << vMax_ << std::endl;
}
